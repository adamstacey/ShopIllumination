 ...
 */
class Version20121222112913 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql("ALTER TABLE product_descriptions ADD variant_id INT DEFAULT NULL");
        ...
        $this->addSql("CREATE INDEX IDX_44CA8CDD3B69A9AF ON product_descriptions (variant_id)");
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql("DROP INDEX IDX_44CA8CDD3B69A9AF ON product_descriptions");
        $this->addSql("ALTER TABLE product_descriptions DROP variant_id");
