...
CREATE TABLE offers (id INT AUTO_INCREMENT NOT NULL, product_id INT DEFAULT NULL, status VARCHAR(1) NOT NULL, type VARCHAR(100) NOT NULL, discount NUMERIC(12, 4) NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, INDEX IDX_DA4604274584665A (product_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB;
