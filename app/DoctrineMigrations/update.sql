...
CREATE TABLE offer_conditions (id INT AUTO_INCREMENT NOT NULL, offer_id INT DEFAULT NULL, type_id INT DEFAULT NULL, parameters LONGTEXT NOT NULL COMMENT '(DC2Type:array)', created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, INDEX IDX_68CCCA7D53C674EE (offer_id), INDEX IDX_68CCCA7DC54C8C93 (type_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB;
CREATE TABLE offer_condition_types (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, parameter_names LONGTEXT NOT NULL COMMENT '(DC2Type:array)', created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB;
CREATE TABLE offer_descriptions (id INT AUTO_INCREMENT NOT NULL, offer_id INT DEFAULT NULL, locale VARCHAR(2) NOT NULL, name VARCHAR(255) NOT NULL, description LONGTEXT DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, INDEX IDX_2E57A10D53C674EE (offer_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB;
CREATE TABLE offers (id INT AUTO_INCREMENT NOT NULL, product_id INT DEFAULT NULL, status VARCHAR(1) NOT NULL, type VARCHAR(100) NOT NULL, fixed_discount NUMERIC(12, 4) NOT NULL, percent_discount NUMERIC(12, 4) NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, INDEX IDX_DA4604274584665A (product_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB;
ALTER TABLE offer_conditions ADD CONSTRAINT FK_68CCCA7D53C674EE FOREIGN KEY (offer_id) REFERENCES offers (id);
ALTER TABLE offer_conditions ADD CONSTRAINT FK_68CCCA7DC54C8C93 FOREIGN KEY (type_id) REFERENCES offer_condition_types (id);
ALTER TABLE offer_descriptions ADD CONSTRAINT FK_2E57A10D53C674EE FOREIGN KEY (offer_id) REFERENCES offers (id);
ALTER TABLE offers ADD CONSTRAINT FK_DA4604274584665A FOREIGN KEY (product_id) REFERENCES products (id);
ALTER TABLE voucher_codes ADD offer_id INT DEFAULT NULL;
ALTER TABLE voucher_codes ADD CONSTRAINT FK_2016977353C674EE FOREIGN KEY (offer_id) REFERENCES offers (id);
CREATE INDEX IDX_2016977353C674EE ON voucher_codes (offer_id);