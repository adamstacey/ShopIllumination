...
ALTER TABLE order_products CHANGE order_id order_id INT DEFAULT NULL, CHANGE product_id product_id INT DEFAULT NULL;
...
INSERT INTO users SET id = 12, username = 'kevin@kitchenappliancecentre.co.uk', username_canonical = 'kevin@kitchenappliancecentre.co.uk', email = 'kevin@kitchenappliancecentre.co.uk', email_canonical = 'kevin@kitchenappliancecentre.co.uk', enabled = 1, salt = 'pm48rom2xmo4sg8wosck84ssoko0kc0', password = 'yGv/ZjPaBFTiTLsCC/YaufFyjyg5T0U5dWXO7igd9Q/eFU/j8UweK+5OFSSte/vQY4DMZVBJ/UeqZn+6di7iRg==', last_login = '2013-03-04 07:07:28', locked = 0, expired = 0, roles = 'a:1:{i:0;s:10:"ROLE_ADMIN";}', credentials_expired = 0;
