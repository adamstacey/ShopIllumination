 ...
 */
class Version20121227122451 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql("ALTER TABLE departments ADD level INT NOT NULL");
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql("ALTER TABLE departments DROP level");
