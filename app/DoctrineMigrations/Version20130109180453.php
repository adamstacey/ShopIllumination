 ...
 */
class Version20130109180453 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql("ALTER TABLE order_products CHANGE product_id product_id INT NOT NULL, CHANGE order_id order_id INT NOT NULL");
    }
