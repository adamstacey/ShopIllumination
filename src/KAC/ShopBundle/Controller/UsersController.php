...
class UsersController extends Controller
{
	...
	public function registerAction(Request $request)
    {
        ...
        return $this->render('KACShopBundle:Users:register.html.twig');
    }
	...
	public function userAction(Request $request)
    {
    	...
    	// Get any orders
    	$orders = $em->getRepository('KACAdminBundle:Order')->findBy(array('emailAddress' => $customer['contact']['contactEmailAddresses'][0]['email']), array('id' => 'DESC'));
    	
        return $this->render('KACShopBundle:Users:user.html.twig', array('customer' => $customer, 'orders' => $orders));
    }
	...
	public function ajaxSaveUserAction(Request $request)
    {
    	...
    	if ($request->isXmlHttpRequest())
    	{
    		...
    		{
    			$contactObject = $em->getRepository('KACAdminBundle:Contact')->find($customer['user']['contactId']);
    		} else {
    			$contactObject = new Contact();
			...
			$userObject = $em->getRepository('KACAdminBundle:User')->find($customer['user']['id']);
			if ($userObject)
			{
				$userObject->setContactId($contactObject->getId());
				$userObject->setEmailAddress($emailAddress);
			...
			$contactEmailAddressObject = $em->getRepository('KACAdminBundle:ContactEmailAddress')->findOneBy(array('contactId' => $contactObject->getId(), 'contactEmailAddressTypeId' => '5'), array('displayOrder' => 'ASC'));
			...
			$telephoneDaytimeObject = $em->getRepository('KACAdminBundle:ContactNumber')->findOneBy(array('contactId' => $contactObject->getId(), 'contactNumberTypeId' => '5'), array('displayOrder' => 'ASC'));
			...
			$telephoneEveningObject = $em->getRepository('KACAdminBundle:ContactNumber')->findOneBy(array('contactId' => $contactObject->getId(), 'contactNumberTypeId' => '6'), array('displayOrder' => 'ASC'));
			...
			$mobileObject = $em->getRepository('KACAdminBundle:ContactNumber')->findOneBy(array('contactId' => $contactObject->getId(), 'contactNumberTypeId' => '2'), array('displayOrder' => 'ASC'));
    		if (!$mobileObject)
    		{
    			$mobileObject = new ContactNumber();
    			$mobileObject->setContactNumberTypeId(2);
	...
	public function ajaxSaveContactAddressesAction(Request $request)
    {
    	...
    	if ($request->isXmlHttpRequest())
    	{
			...
			$billingAddressObject = $em->getRepository('KACAdminBundle:ContactAddress')->findOneBy(array('contactId' => $customer['user']['contactId'], 'contactAddressTypeId' => '4'), array('displayOrder' => 'ASC'));
			...
			$deliveryAddressObject = $em->getRepository('KACAdminBundle:ContactAddress')->findOneBy(array('contactId' => $customer['user']['contactId'], 'contactAddressTypeId' => '5'), array('displayOrder' => 'ASC'));
