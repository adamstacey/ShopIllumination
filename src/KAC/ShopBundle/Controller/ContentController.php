...
use KAC\AdminBundle\Entity\Message;
...
class ContentController extends Controller
{
	...
	public function theShopAction(Request $request)
    {
        ...
        return $this->render('KACShopBundle:Content:theShop.html.twig', array());
    }
	...
	public function cookiePolicyAction(Request $request)
    {
        ...
        return $this->render('KACShopBundle:Content:cookiePolicy.html.twig', array());
    }
	...
	public function contactUsAction(Request $request)
    {
        ...
        return $this->render('KACShopBundle:Content:contactUs.html.twig', array());
    }
	...
	public function linkToUsAction(Request $request)
    {
    	...
    	$imageLinks = array();
    	$imageLinks[] = '<p><a target="_blank" href="http://www.ridedirect.co.uk/"><img alt="Kitchen Appliance Centre - Motocross and enduro off road specialists. Kawasaki main dealer. Shop in derby. Sell all race kits. Sell bike spare parts including plastics. On-site service worktop." src="https://www.ridedirect.co.uk/bundles/kacshop/images/banners/ride-direct-logo.gif" width="370" height="60" /></a></p>';
    	$imageLinks[] = '<p><a target="_blank" href="http://www.ridedirect.co.uk/"><img alt="Ride Direct - Motocross and enduro off road specialists. Kawasaki main dealer. Shop in derby. Sell all race kits. Sell bike spare parts including plastics. On-site service worktop." src="https://www.ridedirect.co.uk/bundles/kacshop/images/banners/qr-code.gif" width="100" height="100" /></a></p>';
    	$imageLinks[] = '<p><a target="_blank" href="http://www.ridedirect.co.uk/"><img alt="Ride Direct - Motocross and enduro off road specialists. Kawasaki main dealer. Shop in derby. Sell all race kits. Sell bike spare parts including plastics. On-site service worktop." src="https://www.ridedirect.co.uk/bundles/kacshop/images/banners/committed-to-giving-riders-more.gif" width="267" height="80" /></a></p>';
    	$imageLinks[] = '<p><a target="_blank" href="http://www.ridedirect.co.uk/"><img alt="Ride Direct - Motocross and enduro off road specialists. Kawasaki main dealer. Shop in derby. Sell all race kits. Sell bike spare parts including plastics. On-site service worktop." src="https://www.ridedirect.co.uk/bundles/kacshop/images/banners/committed-to-giving-riders-more-discounted.gif" width="267" height="112" /></a></p>';
    	$imageLinks[] = '<p><a target="_blank" href="http://www.ridedirect.co.uk/"><img alt="Ride Direct - Motocross and enduro off road specialists. Kawasaki main dealer. Shop in derby. Sell all race kits. Sell bike spare parts including plastics. On-site service worktop." src="https://www.ridedirect.co.uk/bundles/kacshop/images/banners/privilege-card.gif" width="361" height="180" /></a></p>';
        ...
        return $this->render('KACShopBundle:Content:linkToUs.html.twig', array('textLinks' => $textLinks, 'imageLinks' => $imageLinks));
    }
    ...
    {  	
        ...
        return $this->render('KACShopBundle:Content:howToFindUs.html.twig', array());
    }
    ...
    {  	
        ...
        return $this->render('KACShopBundle:Content:usefulLinks.html.twig', array());
    }
    ...
    {  	
        ...
        return $this->render('KACShopBundle:Content:installationGuides.html.twig', array());
    }
    ...
    {  	
        ...
        return $this->render('KACShopBundle:Content:waterPressureInformation.html.twig', array());
    }
    ...
    {   
        ...
        return $this->render('KACShopBundle:Content:returns.html.twig', array());
    }
    ...
    {   
        ...
        return $this->render('KACShopBundle:Content:privacyPolicy.html.twig', array());
    }
    ...
    {   
        ...
        return $this->render('KACShopBundle:Content:termsAndConditions.html.twig', array());
    }
    ...
    {   
        ...
        return $this->render('KACShopBundle:Content:delivery.html.twig', array('basket' => $basket));
    }
    ...
    {   
        ...
        return $this->render('KACShopBundle:Content:security.html.twig', array());
    }
    ...
    {  	
        ...
        return $this->render('KACShopBundle:Content:fraudPrevention.html.twig', array());
    }
    ...
    {   
        ...
        return $this->render('KACShopBundle:Content:privilegeCard.html.twig', array());
    }
    ...
    {   
        ...
        return $this->render('KACShopBundle:Content:giftVouchers.html.twig', array());
    }
    ...
    {   
    	...
    	if ($request->getMethod() == 'POST')
    	{
    		...
    		try
			{
	        	...
	        	$email->setBody($this->renderView('KACShopBundle:Content:trackDayConfirmation.html.twig', array('membershipNumber' => $membershipNumber, 'name' => $name, 'emailAddress' => $emailAddress, 'contactNumber' => $contactNumber, 'postZipCode' => $postZipCode, 'ageRange' => $ageRange, 'dayAttending' => $dayAttending, 'bikeDetails' => $bikeDetails)), 'text/html');
				$email->addPart($this->renderView('KACShopBundle:Content:trackDayConfirmation.txt.twig', array('membershipNumber' => $membershipNumber, 'name' => $name, 'emailAddress' => $emailAddress, 'contactNumber' => $contactNumber, 'postZipCode' => $postZipCode, 'ageRange' => $ageRange, 'dayAttending' => $dayAttending, 'bikeDetails' => $bikeDetails)), 'text/plain');
	    		$this->get('mailer')->send($email);
        ...
        return $this->render('KACShopBundle:Content:trackDay.html.twig', array('basket' => $basket, 'order' => $order));
    }    
}