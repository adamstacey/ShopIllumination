...
class ProductsController extends Controller
{
	...
	public function indexAction($id)
    {
    	...
    	// Create response    	    	    	   		    
    	$response = $this->render('KACShopBundle:Products:index.html.twig', array('backUrl' => $backUrl, 'product' => $product, 'delivery' => $delivery, 'productListingSettings' => $productListingSettings, 'departmentListing' => $departmentListing));
	...
	public function productSearchAction($search)
    {
    	...
    	// Create response    	    	    	   		    
    	$response = $this->render('KACShopBundle:Products:productSearch.html.twig', array('noAjax' => $noAjax, 'search' => $search));
		$response->headers->set('Connection', 'Keep-Alive');
		return $response;
    }
    ...
    {	
    	...
    	// Create response    	    	    	   		    
    	$response = $this->render('KACShopBundle:Products:getProductListingPagination.html.twig', array('noAjax' => 1, 'url' => $url, 'brandId' => $brandId, 'brand' => $brand, 'group' => $group, 'page' => $page, 'maxResults' => $maxResults, 'productPagination' => $productPagination, 'previousPage' => $previousPage, 'nextPage' => $nextPage));
		$response->headers->set('Connection', 'Keep-Alive');
		return $response;
    }
    ...
    {	
		...
		if ($brandId > 0)
		{
    		$brandRoutingObject = $this->getDoctrine()->getRepository('KACAdminBundle:Routing')->findOneBy(array('objectId' => $brandId, 'objectType' => 'brand', 'locale' => $locale));
    	...
    	// Create response    	    	    	   		    
    	$response = $this->render('KACShopBundle:Products:ajaxGetProductListingPagination.html.twig', array('noAjax' => 0, 'url' => $url, 'brandId' => $brandId, 'brand' => $brand, 'group' => $group, 'page' => $page, 'maxResults' => $maxResults, 'productPagination' => $productPagination, 'previousPage' => $previousPage, 'nextPage' => $nextPage));
		$response->headers->set('Connection', 'Keep-Alive');
		return $response;
    }
	...
	public function getProductListingAction($url, $departmentBrand, $departmentGroup, $department, $productListingSettings, $departmentListing)
    {
    	...
    	// Create response    	    	    	   		    
    	$response = $this->render('KACShopBundle:Products:getProductListing.html.twig', array('noAjax' => 1, 'url' => $url, 'products' => $products, 'group' => $group));
		$response->headers->set('Connection', 'Keep-Alive');
		return $response;
    }
	...
	public function ajaxGetProductListingAction(Request $request)
    {
    	...
    	// Create response    	    	    	   		    
    	$response = $this->render('KACShopBundle:Products:ajaxGetProductListing.html.twig', array('noAjax' => 0, 'url' => $url, 'products' => $products, 'group' => $group));
		$response->headers->set('Connection', 'Keep-Alive');
		return $response;
    }
	...
	public function ajaxGetProductPriceAction(Request $request)
    {
		...
		// Create response    	    	    	   		    
    	$response = $this->render('KACShopBundle:Products:ajaxGetProductPrice.html.twig', array('noAjax' => 0, 'price' => $price, 'product' => $product));
		$response->headers->set('Connection', 'Keep-Alive');
		return $response;
    }
	...
	public function getProductSearchAction($search)
    {
    	...
    	// Create response    	    	    	   		    
    	$response = $this->render('KACShopBundle:Products:getProductSearch.html.twig', array('noAjax' => 1, 'products' => $products, 'search' => $search));
		$response->headers->set('Connection', 'Keep-Alive');
		return $response;
    }
	...
	public function ajaxGetProductSearchAction(Request $request)
    {
    	...
    	// Create response    	    	    	   		    
    	$response = $this->render('KACShopBundle:Products:ajaxGetProductSearch.html.twig', array('noAjax' => 0, 'products' => $products, 'search' => $search));
		$response->headers->set('Connection', 'Keep-Alive');
		return $response;
    }
	...
	public function getProductListingBrandFilterAction($url, $departmentBrand, $departmentGroup, $department, $productListingSettings, $departmentListing)
    {
    	...
    	// Create response    	    	    	   		    
    	$response = $this->render('KACShopBundle:Products:getProductListingBrandFilter.html.twig', array('noAjax' => 1, 'brands' => $brands));
		$response->headers->set('Connection', 'Keep-Alive');
		return $response;
    }
	...
	public function ajaxGetProductListingBrandFilterAction(Request $request)
    {
    	...
    	// Create response    	    	    	   		    
    	$response = $this->render('KACShopBundle:Products:ajaxGetProductListingBrandFilter.html.twig', array('noAjax' => 0, 'brands' => $brands));
		$response->headers->set('Connection', 'Keep-Alive');
		return $response;
    }
    ...
    {		
    	...
    	// Create response    	    	    	   		    
    	$response = $this->render('KACShopBundle:Products:getProductListingDepartmentFilter.html.twig', array('noAjax' => 1, 'departments' => $departments));
		$response->headers->set('Connection', 'Keep-Alive');
		return $response;
    }
	...
	public function ajaxGetProductListingDepartmentFilterAction(Request $request)
    {
	    ...
	    {
	    	$departmentBrandId = 0;
			$brandRoutingObject = $this->getDoctrine()->getRepository('KACAdminBundle:Routing')->findOneBy(array('url' => $departmentBrand, 'locale' => 'en', 'objectType' => 'brand'));
			if ($brandRoutingObject)
			{
			...
			{
    			$brandDescriptionObject = $this->getDoctrine()->getRepository('KACAdminBundle:BrandDescription')->findOneBy(array('brandId' => $departmentBrandId));
			}
    	...
    	// Create response    	    	    	   		    
    	$response = $this->render('KACShopBundle:Products:ajaxGetProductListingDepartmentFilter.html.twig', array('noAjax' => 0, 'departments' => $departments));
		$response->headers->set('Connection', 'Keep-Alive');
		return $response;
    }
	...
	public function getProductListingPriceFilterAction($url, $departmentBrand, $departmentGroup, $department, $productListingSettings, $departmentListing)
    {
    	...
    	// Create response    	    	    	   		    
    	$response = $this->render('KACShopBundle:Products:getProductListingPriceFilter.html.twig', array('noAjax' => 1, 'prices' => $prices));
		$response->headers->set('Connection', 'Keep-Alive');
		return $response;
    }
	...
	public function ajaxGetProductListingPriceFilterAction(Request $request)
    {
    	...
    	// Create response    	    	    	   		    
    	$response = $this->render('KACShopBundle:Products:ajaxGetProductListingPriceFilter.html.twig', array('noAjax' => 0, 'prices' => $prices));
		$response->headers->set('Connection', 'Keep-Alive');
		return $response;
    }
	...
	public function getProductListingFeatureFilterAction($url, $departmentBrand, $departmentGroup, $department, $productListingSettings, $departmentListing)
    {
    	...
    	// Create response    	    	    	   		    
    	$response = $this->render('KACShopBundle:Products:getProductListingFeatureFilter.html.twig', array('noAjax' => 1, 'featureGroups' => $featureGroups));
		$response->headers->set('Connection', 'Keep-Alive');
		return $response;
    }
	...
	public function ajaxGetProductListingFeatureFilterAction(Request $request)
    {
    	...
    	// Create response    	    	    	   		    
    	$response = $this->render('KACShopBundle:Products:ajaxGetProductListingFeatureFilter.html.twig', array('noAjax' => 0, 'featureGroups' => $featureGroups));
		$response->headers->set('Connection', 'Keep-Alive');
		return $response;
    }
}