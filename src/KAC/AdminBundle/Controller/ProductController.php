...
namespace KAC\AdminBundle\Controller;
...
use KAC\AdminBundle\Form\EditProductOverviewType;
...
class ProductController extends Controller
{
    ...
    /**
     * @Route("/", name="listing_products_post")
     * @Method({"POST"})
     */
    ...
    public function newAction(Request $request)
    {
         ...
         */
        $flow = $this->get('kac_admin.form.flow.new_product');
        $flow->bind($product);
     ...
     * @Template("KACAdminBundle:Product:edit.html.twig")
     */
