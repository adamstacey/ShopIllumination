...
class VariantToFeature
{
     ...
     * @Assert\NotBlank(groups={"flow_site_new_product_step5", "flow_site_new_product_step2"}, message="Select a feature group.")
     **/
     ...
     * @Assert\NotBlank(groups={"flow_site_new_product_step5", "flow_site_new_product_step2"}, message="Select a feature.")
     **/
    private $feature;
