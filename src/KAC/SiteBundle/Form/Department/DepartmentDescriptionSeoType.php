    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        $builder->add('googleDepartment', 'entity_id', array(
            ...
            'attr' => array(
                ...
                'data-help' => 'Select the equivalent Google department that matches this department. This is very important as Google require this for the Google products feed.',
            ),
        ));
        ...
        $builder->add('menuTitle', 'text', array(
            ...
            'attr' => array(
                'class' => 'fill',
                'data-help' => 'This will usually be the same as the name, but if the name needs to appear different on the menu (e.g. shorter) then this can be set here.',
            ),
        ));
