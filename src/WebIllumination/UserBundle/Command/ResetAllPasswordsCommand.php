...
namespace WebIllumination\UserBundle\Command;
...
class ResetAllPasswordsCommand extends ContainerAwareCommand
{
    ...
    {
        $this
            ->setName('webillumination:user:reset-all-passwords')
...
EOT
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $users = $em->getRepository('WebIllumination\UserBundle\Entity\User')->findAll();
