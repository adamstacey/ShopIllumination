<?php
namespace WebIllumination\AdminBundle\Form\DataTransformer;

use Symfony\Component\Form\DataTransformerInterface;
use Symfony\Component\Form\Exception\TransformationFailedException;
use WebIllumination\SiteBundle\Entity\DepartmentToFeature;
use WebIllumination\SiteBundle\Entity\Product\FeatureGroup;

class FeatureGroupTransformer implements DataTransformerInterface
{
    ...
    public function transform($value)
    {
        ...
        {
            return null;
        } elseif($value instanceof DepartmentToFeature)
        {
            return $value->getProductFeature();
        } elseif($value instanceof FeatureGroup) {
            return $value;
        } else {
            throw new TransformationFailedException("The ID was not specified");
        }
    }
