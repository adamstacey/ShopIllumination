...
$(document).ready(function () {
    ...
    if ($(".floating-buttons-toolbar").length)
    {
        $("footer").css("margin-bottom", $(".floating-buttons-toolbar").outerHeight(true)+"px");
    }
    ...
    $("table.sortable tbody").sortable({
        ...
        update: function(event, ui) {
            ...
            {
                $("#form-save-required").val($saveRequired);
            }
    ...
    $(".action-show-hide-statistics").live('click', function() {
        ...
        if ($("#listing-statistics").is(":hidden"))
        {
            if ($("#listing-statistics").html() != '')
            {
                ...
                $("#listing-statistics-loading").show();
            }
