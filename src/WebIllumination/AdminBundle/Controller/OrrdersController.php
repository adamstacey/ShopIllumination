...
class OrrdersController extends Controller
{
	protected $settings;
	protected $listing;
	protected $filter;
    ...
    public function indexAction(Request $request, $document = '')
    {
		    			...
		    			if (sizeof($select) > 0)
			    		{
			    			if (sizeof($select) == 1)
			    			{
				    			...
				    			foreach ($select as $itemId => $item)
				    			{
								    ...
								    $orderHtml = $this->render('WebIlluminationAdminBundle:Orrders:viewOrders.html.twig', array('orders' => $orders))->getContent();
		    			...
		    			if (sizeof($select) > 0)
			    		{
			    			if (sizeof($select) == 1)
			    			{
				    			...
				    			foreach ($select as $itemId => $item)
				    			{
								    ...
								    $orderHtml = $this->render('WebIlluminationAdminBundle:Orrders:viewCopyOrders.html.twig', array('orders' => $orders))->getContent();
		    			...
		    			if (sizeof($select) > 0)
			    		{
			    			if (sizeof($select) == 1)
			    			{
				    			...
				    			foreach ($select as $itemId => $item)
				    			{
								    ...
								    $orderHtml = $this->render('WebIlluminationAdminBundle:Orrders:viewDeliveryNotes.html.twig', array('orders' => $orders))->getContent();
		    			...
		    			if (sizeof($select) > 0)
			    		{
			    			if (sizeof($select) == 1)
			    			{
				    			...
				    			foreach ($select as $itemId => $item)
				    			{
								    ...
								    $orderHtml = $this->render('WebIlluminationAdminBundle:Orrders:viewInvoices.html.twig', array('orders' => $orders))->getContent();
        ...
        return $this->render('WebIlluminationAdminBundle:Orrders:index.html.twig', array('data' => $data));
    }
    ...
    public function processDeliveriesAction(Request $request)
    {
			    		...
			    		switch ($itemCourier)
			    		{
			    			case 'Royal Mail':			    							    				
								...
								try
								{
									...
									$email->setBody($this->renderView('WebIlluminationAdminBundle:Orrders:message.html.twig', array('order' => $itemObject, 'note' => $htmlNote)), 'text/html');
									$email->addPart($this->renderView('WebIlluminationAdminBundle:Orrders:message.txt.twig', array('order' => $itemObject, 'note' => $plainTextNote)), 'text/plain');
						    		$this->get('mailer')->send($email);
        ...
        return $this->render('WebIlluminationAdminBundle:Orrders:processDeliveries.html.twig', array('data' => $data));
    }
    ...
    public function importTrackingAction(Request $request)
    {
        ...
        return $this->render('WebIlluminationAdminBundle:Orrders:importTracking.html.twig', array('data' => $data));
    }
    ...
    public function updateAction(Request $request, $id)
    {
        ...
        //return $this->render('WebIlluminationAdminBundle:'.$this->settings['multipleModel'].':item.html.twig', array('data' => $data));
        return $this->render('WebIlluminationAdminBundle:Orrders:item.html.twig', array('data' => $data));
    }
    ...
    public function updateNotesAction(Request $request, $id)
    {
				    ...
				    if ($itemNote)
				    {
					    ...
					    if (($itemNotified > 0) && ($itemNoteType == 'customer'))
					    {
							try
							{
					        	...
					        	//$email->setBody($this->renderView('WebIlluminationAdminBundle:'.$this->settings['multipleModel'].':message.html.twig', array('order' => $itemObject, 'note' => $htmlNote)), 'text/html');
								//$email->addPart($this->renderView('WebIlluminationAdminBundle:'.$this->settings['multipleModel'].':message.txt.twig', array('order' => $itemObject, 'note' => $plainTextNote)), 'text/plain');
								$email->setBody($this->renderView('WebIlluminationAdminBundle:Orrders:message.html.twig', array('order' => $itemObject, 'note' => $itemNote)), 'text/html');
								$email->addPart($this->renderView('WebIlluminationAdminBundle:Orrders:message.txt.twig', array('order' => $itemObject, 'note' => $itemNote)), 'text/plain');
					    		$this->get('mailer')->send($email);				    		
							} catch (Exception $exception) {
								error_log('Error sending email!');
							}
        ...
        return $this->render('WebIlluminationAdminBundle:Orrders:itemNotes.html.twig', array('data' => $data));
    }
    ...
    public function viewCopyOrderAction(Request $request, $id)
    {
    	...
    	return $this->render('WebIlluminationAdminBundle:Orrders:viewCopyOrder.html.twig', array('order' => $item));
    }
    ...
    public function viewDeliveryNoteAction(Request $request, $id)
    {
    	...
    	return $this->render('WebIlluminationAdminBundle:Orrders:viewDeliveryNote.html.twig', array('order' => $item));
    }
    ...
    public function viewOrderAction(Request $request, $id)
    {
    	...
    	return $this->render('WebIlluminationAdminBundle:Orrders:viewOrder.html.twig', array('order' => $item));
    }     
}