...
if(!class_exists('dc_jqslicksocial_admin')) {
	...
	class dc_jqslicksocial_admin extends dcwp_dcssb_plugin_admin {
		...
		var $description = 'Add twitter, google +1, google buzz, facebook like, linkedin, stumbleupon & digg social media share buttons in a slick floating or slide out tab';
		...
		function dcssb_admin_init(){
			if (is_admin()) {
				...
				wp_enqueue_style( 'dcssbadmin', dc_jqslicksocial::get_plugin_directory().'/css/admin.css');
			}
		}
		...
		<?php endif; ?>
		<script type="text/javascript" src="<?php echo dc_jqslicksocial::get_plugin_directory(); ?>/inc/js/jquery.ui.core.min.js"></script>
		<script type="text/javascript" src="<?php echo dc_jqslicksocial::get_plugin_directory(); ?>/inc/js/jquery.ui.widget.min.js"></script>
		<script type="text/javascript" src="<?php echo dc_jqslicksocial::get_plugin_directory(); ?>/inc/js/jquery.ui.mouse.min.js"></script>
		<script type="text/javascript" src="<?php echo dc_jqslicksocial::get_plugin_directory(); ?>/inc/js/jquery.ui.sortable.min.js"></script>
		...
		<p class="dcwp-intro">For instructions on how to configure this plugin check out the <a target="_blank" href="http://www.designchemical.com/blog/index.php/wordpress-plugins/wordpress-plugin-slick-social-share-buttons/"><?php echo $this->shortname; ?> project page</a>.</p>
			<?php 
				...
				$default_order = 'twitter,facebook,plusone,linkedin,stumble,digg,buzz' ;
				    ...
				    <div class="postbox">
					  ...
					  <ul>
						  ...
						  <li>
						   ...
						   <li>
						    <label for="dcssb_image_buzz">Default Google Buzz Image</label>
							<input type="text" name="dcssb_options[image_buzz]" id="dcssb_image_buzz" class="dcwp-input-m" value="<?php echo isset($options['image_buzz']) ?  $options['image_buzz'] : $image_buzz; ?>" />
					       </li>
					  </ul>
					  <p class="submit">
					...
					<td class="button-eg" rel="dcssb_size_facebook">
						<div class="relative">
							...
							<span class="dcssb-button size_facebook standard">
							  <iframe src="http://www.facebook.com/plugins/like.php?app_id=<?php echo $appId; ?>&amp;href=<?php echo urlencode($this->homepage); ?>&amp;send=false&amp;layout=standard&amp;width=48&amp;show_faces=false&amp;action=like&amp;colorscheme=light&amp;font&amp;height=60" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:48px; height:60px;" allowTransparency="true"></iframe>
							</span>
							
							<span class="dcssb-button size_facebook box_count">
							  <iframe src="http://www.facebook.com/plugins/like.php?app_id=<?php echo $appId; ?>&amp;href=<?php echo urlencode($this->homepage); ?>&amp;send=false&amp;layout=box_count&amp;width=48&amp;show_faces=false&amp;action=like&amp;colorscheme=light&amp;font&amp;height=60" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:48px; height:60px;" allowTransparency="true"></iframe>
							</span>
							
							<span class="dcssb-button size_facebook button_count">
							  <iframe src="http://www.facebook.com/plugins/like.php?app_id=<?php echo $appId; ?>&amp;href=<?php echo urlencode($this->homepage); ?>&amp;send=false&amp;layout=button_count&amp;width=48&amp;show_faces=false&amp;action=like&amp;colorscheme=light&amp;font&amp;height=60" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:48px; height:60px;" allowTransparency="true"></iframe>
							</span>
					...
					<td class="button-eg" rel="dcssb_size_stumble">
						<div class="relative">
							...
							<span class="dcssb-button size_stumble 1">
							  <iframe src="http://www.stumbleupon.com/badge/embed/1/?url=<?php echo urlencode($this->homepage); ?>" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:50px; height: 60px;" allowTransparency="true"></iframe>
							</span>
							
							<span class="dcssb-button size_stumble 2">
							  <iframe src="http://www.stumbleupon.com/badge/embed/2/?url=<?php echo urlencode($this->homepage); ?>" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:50px; height: 60px;" allowTransparency="true"></iframe>
							</span>
							
							<span class="dcssb-button size_stumble 3">
							  <iframe src="http://www.stumbleupon.com/badge/embed/3/?url=<?php echo urlencode($this->homepage); ?>" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:50px; height: 60px;" allowTransparency="true"></iframe>
							</span>
							
							<span class="dcssb-button size_stumble 4">
							  <iframe src="http://www.stumbleupon.com/badge/embed/4/?url=<?php echo urlencode($this->homepage); ?>" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:50px; height: 60px;" allowTransparency="true"></iframe>
							</span>
		...
		function options_buzz(){
		
			$options = get_option('dcssb_options');
			$size_buzz = $options['size_buzz'] ? $options['size_buzz'] : 'normal-count' ;
			$incBuzz = $options['incBuzz'] ? $options['incBuzz'] : 'false' ;
			...
			<li rel="buzz">
				  ...
				  <tr>
				    <td class="button-name">
					  <h4><input type="checkbox" value="true" class="checkbox" id="dcssb_inc_buzz" name="dcssb_options[incBuzz]"<?php checked( $incBuzz, 'true'); ?> class="margin-right" /> Google Buzz</h4>
					</td>
					<td class="button-size">
						<select name="dcssb_options[size_buzz]" id="dcssb_size_buzz" class="dcssb-button">
							<option value='normal-count' <?php selected( $size_buzz, 'normal-count'); ?> >Normal + Count</option>
							<option value='small-count' <?php selected( $size_buzz, 'small-count'); ?> >Small + Count</option>
							<option value='normal-button' <?php selected( $size_buzz, 'normal-button'); ?> >Normal</option>
							<option value='small-button' <?php selected( $size_buzz, 'small-button'); ?> >Small</option>
							<option value='link' <?php selected( $size_buzz, 'link'); ?> >Link</option>
						</select>
					</td>
					<td class="button-others">&nbsp;</td>
					<td class="button-eg" rel="dcssb_size_buzz">
						<div class="relative">
						
							<span class="dcssb-button size_buzz normal-count">
							  <a href="http://www.google.com/buzz/post" class="google-buzz-button" title="Google Buzz" data-message="<?php echo $this->title; ?>" data-url="<?php echo $this->homepage; ?>" data-imageurl="<?php echo $this->imageurl; ?>" data-button-style="normal-count"></a>
							</span>
							
							<span class="dcssb-button size_buzz small-count">
							  <a href="http://www.google.com/buzz/post" class="google-buzz-button" title="Google Buzz" data-message="<?php echo $this->title; ?>" data-url="<?php echo $this->homepage; ?>" data-imageurl="<?php echo $this->imageurl; ?>" data-button-style="small-count"></a>
							</span>
							
							<span class="dcssb-button size_buzz normal-button">
							  <a href="http://www.google.com/buzz/post" class="google-buzz-button" title="Google Buzz" data-message="<?php echo $this->title; ?>" data-url="<?php echo $this->homepage; ?>" data-imageurl="<?php echo $this->imageurl; ?>" data-button-style="normal-button"></a>
							</span>
							
							<span class="dcssb-button size_buzz small-button">
							  <a href="http://www.google.com/buzz/post" class="google-buzz-button" title="Google Buzz" data-message="<?php echo $this->title; ?>" data-url="<?php echo $this->homepage; ?>" data-imageurl="<?php echo $this->imageurl; ?>" data-button-style="small-button"></a>
							</span>
							
							<span class="dcssb-button size_buzz link">
							  <a href="http://www.google.com/buzz/post" class="google-buzz-button" title="Google Buzz" data-message="<?php echo $this->title; ?>" data-url="<?php echo $this->homepage; ?>" data-imageurl="<?php echo $this->imageurl; ?>" data-button-style="link"></a>
							</span>
