...
Slick social share buttons adds facebook, twitter, google +1, google buzz, linkedin, digg, and stumbleupon social media buttons in a floating or slide out tab.

== Description ==

Add facebook, twitter, google +1, google buzz, linkedin, digg, and stumbledupon social media buttons to your website in either a floating or sliding panel.
...
3. In the plugin configuration screen select the required settings
4. Click save to activate the social buttons
