 ...
 */
class WebIlluminationAdminBundleEntityProductOptionProxy extends \WebIllumination\AdminBundle\Entity\ProductOption implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'productOptionGroupId', 'active', 'productOption', 'locale', 'createdAt', 'updatedAt');
    }
