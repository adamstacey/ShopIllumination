 ...
 */
class WebIlluminationAdminBundleEntityLinkProxy extends \WebIllumination\AdminBundle\Entity\Link implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'objectId', 'objectType', 'imageType', 'locale', 'title', 'description', 'alignment', 'link', 'defaultImage', 'displayOrder', 'originalPath', 'thumbnailPath', 'mediumPath', 'largePath', 'createdAt', 'updatedAt');
    }
