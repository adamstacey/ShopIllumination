...
class __TwigTemplate_9a9197700edba876ad4ccfe3d1bac0eb extends Twig_Template
{
...
\t\t\t<div class=\"portlet\">
\t\t\t\t<header>
\t                <h2>Kitchen Appliance Centre Cookies Policy</h2>
\t            </header>
\t\t\t\t<section>
\t\t\t\t\t<div class=\"clearfix\">
\t\t\t\t\t\t<p class=\"no-margin-top\">This privacy policy sets out how <strong>Kitchen Appliance Centre</strong> uses and protects any information that you give <strong>Kitchen Appliance Centre</strong> when you use this website.</p>
\t\t\t\t\t\t<p><strong>Kitchen Appliance Centre</strong> is committed to ensuring that your privacy is protected. Should we ask you to provide certain information by which you can be identified when using this website, then you can be assured that it will only be used in accordance with this privacy statement.</p>
\t\t\t\t\t\t<p><strong>Kitchen Appliance Centre</strong> may change this policy from time to time by updating this page. You should check this page from time to time to ensure that you are happy with any changes. This policy is effective from 1st January 2012.</p>
...
\t\t\t\t\t\t\t<li>if you have previously agreed to us using your personal information for direct marketing purposes, you may change your mind at any time by writing to or emailing us at <a href=\"mailto:customerservice@kitchenappliancecentre.co.uk\">customerservice@kitchenappliancecentre.co.uk</a></li>
\t\t\t\t\t\t</ul>
\t\t\t\t\t\t<p>We will not sell, distribute or lease your personal information to third parties unless we have your permission or are required by law to do so. We may use your personal information to send you promotional information about third parties which we think you may find interesting if you tell us that you wish this to happen.</p>
\t\t\t\t\t\t<p>You may request details of personal information which we hold about you under the Data Protection Act 1998. A small fee will be payable. If you would like a copy of the information held on you please write to Kitchen Appliance Centre, Unit 3 Pentrich Road, Giltbrook Industrial Park, Giltbrook, Nottingham, NG16 2UZ.</p>
\t\t\t\t\t\t<p class=\"no-margin-bottom\">If you believe that any information we are holding on you is incorrect or incomplete, please write to or email us as soon as possible at the above address. We will promptly correct any information found to be incorrect.</p>
\t\t\t\t\t</div>
\t\t\t\t</section>
\t        </div>
\t    </div>
...
";
    ...
    {
        return "WebIlluminationShopBundle:Content:cookiesPolicy.html.twig";
    }
