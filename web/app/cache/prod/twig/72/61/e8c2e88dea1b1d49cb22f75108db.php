...
/* WebIlluminationShopBundle:Security:resetPasswordEmail.html.twig */
class __TwigTemplate_7261e8c2e88dea1b1d49cb22f75108db extends Twig_Template
{
    ...
    {
        echo "Ride Direct Password Assistance | ";
...
\t\t\t\t\t\t\t\t\t\t<p style=\"font-family: Arial; font-size: 11px; color: #000000; padding: 0 0 10px 0; margin: 0; line-height: 120%;\">We received a request to reset the password associated with this email address. If you made this request, please follow the instructions below.</p>
\t\t\t\t\t\t\t\t\t\t<p style=\"font-family: Arial; font-size: 11px; color: #000000; padding: 0 0 10px 0; margin: 0; line-height: 120%;\">Click on the link below to reset your password using our secure server:</p>
\t\t\t\t\t\t\t\t\t\t<p style=\"font-family: Arial; font-size: 11px; color: #000000; padding: 0 0 10px 0; margin: 0; line-height: 120%;\"><a style=\"font-family: Arial; font-size: 11px; color: #5FA729;\" target=\"_blank\" href=\"";
        // line 15
        echo twig_escape_filter($this->env, $this->getContext($context, "passwordResetLink"), "html", null, true);
        echo "\">";
        echo twig_escape_filter($this->env, $this->getContext($context, "passwordResetLink"), "html", null, true);
        echo "</a></p>
\t\t\t\t\t\t\t\t\t\t<p style=\"font-family: Arial; font-size: 11px; color: #000000; padding: 0 0 10px 0; margin: 0; line-height: 120%;\">If you did not request to have your password reset you can safely ignore this email. Rest assured your account is safe.</p>
\t\t\t\t\t\t\t\t\t\t<p style=\"font-family: Arial; font-size: 11px; color: #000000; padding: 0 0 10px 0; margin: 0; line-height: 120%;\">If clicking the link does not seem to work, you can copy and paste the link into your browser's address bar, or retype it there. Once you have returned to the Ride Direct site, we will give you instructions on resetting your password.</p>
\t\t\t\t\t\t\t\t\t\t<p style=\"font-family: Arial; font-size: 11px; color: #000000; padding: 0 0 10px 0; margin: 0; line-height: 120%;\">Ride Drect will never email you and ask you to disclose or verify your Ride Direct password, credit card, or bank account number. If you receive a suspicious email with a link to update your account information, do not click on the link. Iinstead, report the email to Ride Direct for investigation.</p>
\t\t\t\t\t\t\t\t\t\t";
        // line 19
...
";
    ...
    {
        return "WebIlluminationShopBundle:Security:resetPasswordEmail.html.twig";
    }
