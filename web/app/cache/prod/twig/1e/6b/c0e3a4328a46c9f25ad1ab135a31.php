...
class __TwigTemplate_1e6bc0e3a4328a46c9f25ad1ab135a31 extends Twig_Template
{
    ...
    {
        // line 1
        echo "<div class=\"ui-helper-hidden more-information-detail no-margin no-padding\" id=\"membership-card-confirm-release-user-";
        echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "membershipCard"), "id"), "html", null, true);
        echo "\">
\t<div id=\"membership-card-confirm-release-user-";
        // line 2
        echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "membershipCard"), "id"), "html", null, true);
...
\t    \t\t<p class=\"small-message\"><strong>WARNING:</strong> Are you sure you want to release the customer from this membership card?</p>
\t    \t</div>
\t        <div class=\"fr no-margin no-padding\">
\t        \t<a href=\"Javascript:void(0);\" data-id=\"";
        // line 9
        echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "membershipCard"), "id"), "html", null, true);
        echo "\" class=\"button ui-corner-none ui-corner-tr ui-corner-br ui-button-red action-release-user\" data-icon-primary=\"ui-icon-refresh\">Confirm Release</a>
\t        \t<a href=\"Javascript:void(0);\" data-id=\"";
        // line 10
        echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "membershipCard"), "id"), "html", null, true);
        echo "\" class=\"button ui-corner-none ui-corner-tl ui-corner-bl ui-button-blue action-confirm-release-user\">Cancel</a>
\t        </div>
\t        <div class=\"clear\"></div>
\t    </div>
\t</div>
    ...
    {
        return "WebIlluminationAdminBundle:MembershipCards:listingConfirmReleaseUser.html.twig";
    }
