...
class __TwigTemplate_24c2766e3af47518017541b93730eb8b extends Twig_Template
{
...
\t\t\t<option";
        // line 5
        if (($this->getAttribute($this->getAttribute($this->getAttribute($this->getContext($context, "settings"), "admin"), "membershipCards"), "listingSortOrder") == "membershipNumber:ASC")) {
            echo " selected=\"selected\"";
        }
        echo " value=\"membershipNumber:ASC\">Membership Number: Lowest First</option>
\t\t\t<option";
        // line 6
        if (($this->getAttribute($this->getAttribute($this->getAttribute($this->getContext($context, "settings"), "admin"), "membershipCards"), "listingSortOrder") == "membershipNumber:DESC")) {
            echo " selected=\"selected\"";
        }
        echo " value=\"membershipNumber:DESC\">Membership Number: Highest First</option>
\t\t\t<option";
        // line 7
        if (($this->getAttribute($this->getAttribute($this->getAttribute($this->getContext($context, "settings"), "admin"), "membershipCards"), "listingSortOrder") == "expiryDate:DESC")) {
            echo " selected=\"selected\"";
        }
        echo " value=\"createdAt:DESC\">Expiry Date</option>
\t\t\t<option";
        // line 8
        if (($this->getAttribute($this->getAttribute($this->getAttribute($this->getContext($context, "settings"), "admin"), "membershipCards"), "listingSortOrder") == "validFromDate:DESC")) {
            echo " selected=\"selected\"";
        }
...
\t\t\t<option";
        // line 14
        if (($this->getAttribute($this->getAttribute($this->getAttribute($this->getContext($context, "settings"), "admin"), "membershipCards"), "listingMaxResults") == "10")) {
            echo " selected=\"selected\"";
        }
        echo " value=\"10\">10</option>
\t\t\t<option";
        // line 15
        if (($this->getAttribute($this->getAttribute($this->getAttribute($this->getContext($context, "settings"), "admin"), "membershipCards"), "listingMaxResults") == "20")) {
            echo " selected=\"selected\"";
        }
        echo " value=\"20\">20</option>
\t\t\t<option";
        // line 16
        if (($this->getAttribute($this->getAttribute($this->getAttribute($this->getContext($context, "settings"), "admin"), "membershipCards"), "listingMaxResults") == "50")) {
            echo " selected=\"selected\"";
        }
        echo " value=\"50\">50</option>
\t\t\t<option";
        // line 17
        if (($this->getAttribute($this->getAttribute($this->getAttribute($this->getContext($context, "settings"), "admin"), "membershipCards"), "listingMaxResults") == "100")) {
            echo " selected=\"selected\"";
        }
        echo " value=\"100\">100</option>
\t\t\t<option";
        // line 18
        if (($this->getAttribute($this->getAttribute($this->getAttribute($this->getContext($context, "settings"), "admin"), "membershipCards"), "listingMaxResults") == "99999999")) {
            echo " selected=\"selected\"";
        }
...
\t</div>
    ...
    {
        return "WebIlluminationAdminBundle:MembershipCards:listingSettings.html.twig";
    }
