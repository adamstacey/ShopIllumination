...
class __TwigTemplate_16a3a9d6b0f23fc0b7e80e19e38d1a91 extends Twig_Template
{
    ...
    {
        echo "Ride Direct Gift Vouchers | ";
...
\t\t\t\t\t\t<img src=\"";
        // line 9
        echo twig_escape_filter($this->env, $this->env->getExtension('assets')->getAssetUrl("/bundles/webilluminationshop/images/headers/gift-vouchers.jpg"), "html", null, true);
        echo "\" alt=\"Ride Direct Gift Vouchers\" />
\t\t\t
\t\t\t\t\t</div>
\t\t\t\t</div>
\t\t\t</div>
...
";
    ...
    public function block_body($context, array $blocks = array())
    {
        // line 18
        echo "\t<header>
\t\t<h2>Ride Direct Gift Vouchers Now Available</h2>
\t</header>
\t<section class=\"container_6 clearfix\">
\t\t<div class=\"grid_4\"> 
\t\t\t<div class=\"portlet\">
\t\t\t\t<header>
\t                <h2>About Our Gift Vouchers</h2>
\t            </header>
\t\t\t\t<section>
\t\t\t\t\t<div class=\"clearfix\">
\t\t\t\t\t<p>Looking for the perfect gift? Look no further, the Ride Direct gift vouchers are the perfect gift for birthdays, Christmas, or any occasion.</p>
\t\t\t\t\t\t<ul>
\t\t\t\t\t\t\t<li>Available in &pound;25, &pound;50 &amp; &pound;100</li>
\t\t\t\t\t\t\t<li>Redeemable on any product(s) online at ridedirect.co.uk or in store</li>
\t\t\t\t\t\t</ul>
\t\t\t\t\t</div>
\t\t\t\t</section>
\t        </div>
...
\t\t\t";
        // line 63
        echo "\t\t\t\$(\".action-add-privilege-card-to-basket\").live('click', function() {
\t\t\t\t\$(\"#ajax-loading\").show();
\t\t\t\t\$.ajax({
\t   \t\t\t\ttype: \"POST\",
\t   \t\t\t\turl: \"";
...
\t\t\t\t\t\t\$(\"#basket-summary\").expose({
\t\t\t\t\t\t\tcolor: \"#000000\",
\t\t\t\t\t\t\topacity: 0.4
\t\t\t\t\t\t});
\t\t\t\t\t\tsetTimeout(\"\$.mask.close()\", 4000);
\t\t\t\t\t\t\$(\"#ajax-loading\").hide();
\t   \t\t\t\t}
\t \t\t\t});
\t\t\t});
...
";
    ...
    {
        return "WebIlluminationShopBundle:Content:giftVouchers.html.twig";
    }
