...
/* WebIlluminationAdminBundle:Products:updateRelatedProductsScript.js.twig */
class __TwigTemplate_70542e853f8bea72eeb4674b1d0e2fa3 extends Twig_Template
{
    ...
    {
        // line 2
        echo "loadRelatedProducts();

";
        // line 5
        echo "\$(\".action-unselect-all-related-products\").hide();
...
";
        // line 24
        echo "\$(\".action-confirm-delete-related-products\").hide();
...
";
        // line 49
        echo "\$(\".action-add-new-related-product\").live('click', function() {
...
";
        // line 61
        echo "\$(\".action-update-related-products-and-leave\").live('click', function() {
\t\$(\"#related-products .message\").hide();
\t\$(\".form-error\").remove();
...
";
        // line 68
        echo "\$(\".action-update-related-products\").live('click', function() {
\t\$(\"#related-products .message\").hide();
\t\$(\".form-error\").remove();
...
";
        // line 76
        echo "\$(\".action-confirm-delete-related-product\").live('click', function() {
\t\$(\"#related-products .message\").hide();
\t\$(\".form-error\").remove();
\t\$(\"#ajax_loading\").show();
...
";
        // line 109
        echo "\$(\".action-cancel-delete-related-product\").live('click', function() {
\t\$(\"#related-products .message\").hide();
\t\$(\".form-error\").remove();
\t\$(\"#ajax_loading\").show();
\t\$elementIndex = \$(this).attr(\"data-index\");
...
";
        // line 122
        echo "\$(\".action-delete-related-product\").live('click', function() {
\t\$(\"#related-products .message\").hide();
\t\$(\".form-error\").remove();
\t\$(\"#ajax_loading\").show();
\t\$elementIndex = \$(this).attr(\"data-index\");\t\t\t\t
\t\$.ajax({
    \turl: \"";
        // line 128
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath((("admin_" . $this->getAttribute($this->getContext($context, "settings"), "multipleItemsPath")) . "_ajax_delete_related_product")), "html", null, true);
        echo "\",
      \ttype: \"GET\",
      \tdataType: \"json\",
      \tdata: {
...
";
        // line 169
        echo "\$(\".action-confirm-delete-related-products\").live('click', function() {
\t\$(\"#related-products .message\").hide();
\t\$(\".form-error\").remove();
\t\$(\"#ajax_loading\").show();
...
";
        // line 204
        echo "\$(\".action-cancel-delete-related-products\").live('click', function() {
\t\$(\"#related-products .message\").hide();
\t\$(\".form-error\").remove();
\t\$(\"#ajax_loading\").show();
...
";
        // line 213
        echo "\$(\".action-delete-related-products\").live('click', function() {
\t\$(\"#related-products .message\").hide();
\t\$(\".form-error\").remove();
\t\$(\"#ajax_loading\").show();
\t\$errorOccurred = false;
...
\t\$(\"html, body\").animate({scrollTop: \$(\"#related-products\").offset().top + 35},'slow');
    ...
    {
        return "WebIlluminationAdminBundle:Products:updateRelatedProductsScript.js.twig";
    }
