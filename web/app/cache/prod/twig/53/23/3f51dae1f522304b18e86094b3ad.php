...
/* WebIlluminationAdminBundle:Brands:updateDescription.html.twig */
class __TwigTemplate_53233f51dae1f522304b18e86094b3ad extends Twig_Template
{
...
\t</div>
    <div class=\"accordion clearfix\">
        <header class=\"current\"><a href=\"#\">Description</a></header>
        <section>
            <div class=\"clearfix\">
...
\t\t                    <textarea id=\"form-description\" name=\"description\" rows=\"3\" class=\"tinymce-basic\">";
        // line 34
        echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($this->getContext($context, "data"), "brand"), "description"), "html", null, true);
        echo "</textarea>
\t\t                </div>
\t\t            </div>
\t\t        </div>
\t\t    </div>
        ...
        <header><a href=\"#\">About</a></header>
        <section>
            <div class=\"clearfix\">
\t\t        <div class=\"form-input-long\">
\t\t        \t<div class=\"ac\">
\t\t                <div class=\"buttonset no-margin-right\">
\t\t                    <input type=\"radio\" class=\"show-tinymce\" rel=\"#form-about\" name=\"tinymce-about\" value=\"1\" id=\"tinymce-about-1\" checked=\"checked\" /><label for=\"tinymce-about-1\">Visual</label>
\t\t                    <input type=\"radio\" class=\"show-tinymce\" rel=\"#form-about\" name=\"tinymce-about\" value=\"0\" id=\"tinymce-about-0\" /><label for=\"tinymce-about-0\">HTML</label>
\t\t                    <hr class=\"inset\" />
\t\t                </div>
\t\t                <div class=\"leading\">
\t\t                    <textarea id=\"form-about\" name=\"about\" rows=\"3\" class=\"tinymce-basic\">";
        // line 51
        echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($this->getContext($context, "data"), "brand"), "about"), "html", null, true);
        echo "</textarea>
\t\t                </div>
\t\t            </div>
\t\t        </div>
\t\t    </div>
        ...
        <header><a href=\"#\">History</a></header>
        <section>
            <div class=\"clearfix\">
\t\t        <div class=\"form-input-long\">
\t\t        \t<div class=\"ac\">
\t\t                <div class=\"buttonset no-margin-right\">
\t\t                    <input type=\"radio\" class=\"show-tinymce\" rel=\"#form-history\" name=\"tinymce-history\" value=\"1\" id=\"tinymce-history-1\" checked=\"checked\" /><label for=\"tinymce-history-1\">Visual</label>
\t\t                    <input type=\"radio\" class=\"show-tinymce\" rel=\"#form-history\" name=\"tinymce-history\" value=\"0\" id=\"tinymce-history-0\" /><label for=\"tinymce-history-0\">HTML</label>
\t\t                    <hr class=\"inset\" />
\t\t                </div>
\t\t                <div class=\"leading\">
\t\t                    <textarea id=\"form-history\" name=\"history\" rows=\"3\" class=\"tinymce-basic\">";
        // line 68
        echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($this->getContext($context, "data"), "brand"), "history"), "html", null, true);
        echo "</textarea>
\t\t                </div>
\t\t            </div>
\t\t        </div>
\t\t    </div>
        ...
        <header><a href=\"#\">More Information</a></header>
        <section>
            <div class=\"clearfix\">
\t\t        <div class=\"form-input-long\">
\t\t        \t<div class=\"ac\">
\t\t                <div class=\"buttonset no-margin-right\">
\t\t                    <input type=\"radio\" class=\"show-tinymce\" rel=\"#form-more-information\" name=\"tinymce-more-information\" value=\"1\" id=\"tinymce-more-information-1\" checked=\"checked\" /><label for=\"tinymce-more-information-1\">Visual</label>
\t\t                    <input type=\"radio\" class=\"show-tinymce\" rel=\"#form-more-information\" name=\"tinymce-more-information\" value=\"0\" id=\"tinymce-more-information-0\" /><label for=\"tinymce-more-information-0\">HTML</label>
\t\t                    <hr class=\"inset\" />
\t\t                </div>
\t\t                <div class=\"leading\">
\t\t                    <textarea id=\"form-more-information\" name=\"more-information\" rows=\"3\" class=\"tinymce-basic\">";
        // line 85
        echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($this->getContext($context, "data"), "brand"), "moreInformation"), "html", null, true);
        echo "</textarea>
\t\t                </div>
\t\t            </div>
\t\t        </div>
\t\t    </div>
    ...
    <div class=\"clearfix\">
        ...
        \t<button class=\"button ui-button-green action-update-description-section\" data-icon-primary=\"ui-icon-check\">Update</button>
        </div>
    </div>
</section>";
    }
    ...
    {
        return "WebIlluminationAdminBundle:Brands:updateDescription.html.twig";
    }
