...
/* WebIlluminationAdminBundle:BrandsOld:sectionGuarantees.html.twig */
class __TwigTemplate_962788801bfd36b1336a5efb8e352ea8 extends Twig_Template
{
...
\t\t\t";
   ...
   \t\t\t\turl: \"";
        // line 21
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("system_ajax_guarantees"), "html", null, true);
        echo "\",
   \t\t\t\tdata: {
   \t\t\t\t\tobject_id: ";
        // line 23
...
\t</script>
    ...
    {
        return "WebIlluminationAdminBundle:BrandsOld:sectionGuarantees.html.twig";
    }
