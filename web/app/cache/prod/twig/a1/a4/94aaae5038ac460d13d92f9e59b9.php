...
/* WebIlluminationShopBundle:Basket:ajaxGetBasketContents.html.twig */
class __TwigTemplate_a1a494aaae5038ac460d13d92f9e59b9 extends Twig_Template
{
...
\t\t\t<th class=\"ac\">Code</th>
\t\t\t<th class=\"ac\" colspan=\"5\">Price</th>
\t\t\t<th class=\"ac\">Remove</th>
\t\t</tr>
\t\t";
            // line 9
...
\t\t\t\t<td class=\"ac\"><strong>";
                ...
                echo "</strong></td>
\t\t\t\t<td class=\"ac\"><input id=\"quantity-";
                // line 21
                echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "product"), "productId"), "html", null, true);
                echo "\" data-selected-options=\"";
                echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "product"), "selectedOptions"), "html", null, true);
                echo "\" data-product-id=\"";
                echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "product"), "productId"), "html", null, true);
                echo "\" class=\"number quantity\" width=\"10\" type=\"text\" value=\"";
...
\t\t\t\t<td class=\"ac\">&pound;";
                ...
                echo "</td>
\t\t\t\t<td class=\"ac\"><img data-basket-item-id=\"";
                // line 26
                echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "product"), "basketItemId"), "html", null, true);
                echo "\" class=\"link action-delete-basket-item\" src=\"";
                ...
                echo "\" border=\"0\" alt=\"Delete Item\" /></td>
\t\t\t</tr>
\t\t";
            }
            $_parent = $context['_parent'];
            ...
            // line 29
            echo "\t\t";
            if (($this->getAttribute($this->getAttribute($this->getContext($context, "basket"), "discounts"), "membershipCardNumber") == 1)) {
                // line 30
                echo "\t\t\t<tr>
\t\t\t\t<td><a href=\"";
                // line 31
...
\t\t\t\t<td class=\"ac\">1</td>
\t\t\t\t<td class=\"ac\">&times;</td>
\t\t\t\t<td class=\"ac\">&pound;1.00</td>
\t\t\t\t<td class=\"ac\">=</td>
\t\t\t\t<td class=\"ac\">&pound;1.00</td>
\t\t\t\t<td class=\"ac\"><img class=\"link action-delete-membership-card\" src=\"";
                // line 38
                echo twig_escape_filter($this->env, $this->env->getExtension('assets')->getAssetUrl("/bundles/webilluminationshop/images/icons/error-small.png"), "html", null, true);
                echo "\" border=\"0\" alt=\"Delete Privilege Card\"></td>
\t\t\t</tr>
\t\t";
            }
            // line 41
...
\t\t\t";
            // line 48
            if ((($this->getAttribute($this->getContext($context, "message"), "type") == "notice") && ($this->getAttribute($this->getContext($context, "message"), "text") != ""))) {
                // line 49
                echo "\t\t\t\t\$(\"#message-notice-text\").html('";
                echo $this->getAttribute($this->getContext($context, "message"), "text");
                echo "');
\t\t\t\t\$(\"#message-notice\").slideDown(function() {
...
\t\t\t";
            ...
            // line 54
            echo "\t\t\t";
            if ((($this->getAttribute($this->getContext($context, "message"), "type") == "success") && ($this->getAttribute($this->getContext($context, "message"), "text") != ""))) {
                // line 55
                echo "\t\t\t\t\$(\"#message-success-text\").html('";
                echo $this->getAttribute($this->getContext($context, "message"), "text");
                echo "');
...
\t\t\t";
            ...
            // line 60
            echo "\t\t\t";
            if ((($this->getAttribute($this->getContext($context, "message"), "type") == "error") && ($this->getAttribute($this->getContext($context, "message"), "text") != ""))) {
                // line 61
                echo "\t\t\t\t\$(\"#message-error-text\").html('";
                echo $this->getAttribute($this->getContext($context, "message"), "text");
                echo "');
...
";
    ...
    {
        return "WebIlluminationShopBundle:Basket:ajaxGetBasketContents.html.twig";
    }
