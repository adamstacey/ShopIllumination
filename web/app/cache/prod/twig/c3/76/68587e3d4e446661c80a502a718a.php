...
class __TwigTemplate_c37668587e3d4e446661c80a502a718a extends Twig_Template
{
    ...
    {
        // line 1
        echo "<li class=\"redirect-container\" data-index=\"";
...
\t\t\t\t\t\t<input data-index=\"";
        // line 7
        echo twig_escape_filter($this->env, $this->getContext($context, "index"), "html", null, true);
        echo "\" type=\"checkbox\" class=\"redirect-select\" id=\"form-redirect-select-";
        echo twig_escape_filter($this->env, $this->getContext($context, "index"), "html", null, true);
        echo "\" value=\"1\" />
\t\t\t\t\t</td>
\t\t\t\t\t<td>
\t\t\t\t\t\t<input type=\"text\" required=\"required\" data-message=\"Please enter a redirect.\" class=\"seo-url redirect-from\" id=\"form-redirect-from-";
        // line 10
        echo twig_escape_filter($this->env, $this->getContext($context, "index"), "html", null, true);
        echo "\" name=\"redirect-from-";
        echo twig_escape_filter($this->env, $this->getContext($context, "index"), "html", null, true);
        echo "\" placeholder=\"Enter a redirect\" value=\"";
        if ($this->getAttribute($this->getContext($context, "data", true), "redirectFrom", array(), "any", true, true)) {
            echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "data"), "redirectFrom"), "html", null, true);
        }
        echo "\" />
\t\t\t\t\t</td>
\t\t\t\t\t<td width=\"1\">
\t\t\t\t\t\t<select autocomplete=\"off\" class=\"redirect-code full\" name=\"redirect-code-";
        // line 13
        echo twig_escape_filter($this->env, $this->getContext($context, "index"), "html", null, true);
        echo "\" id=\"form-redirect-code-";
        echo twig_escape_filter($this->env, $this->getContext($context, "index"), "html", null, true);
        echo "\">
\t\t\t        \t\t<option value=\"301\"";
        // line 14
        if ($this->getAttribute($this->getContext($context, "data", true), "redirectCode", array(), "any", true, true)) {
            if (($this->getAttribute($this->getContext($context, "data"), "redirectCode") == "301")) {
...
\t\t\t\t\t\t<input type=\"hidden\" data-index=\"";
        // line 18
        echo twig_escape_filter($this->env, $this->getContext($context, "index"), "html", null, true);
        echo "\" class=\"redirect-requires-update\" id=\"form-redirect-requires-update-";
        echo twig_escape_filter($this->env, $this->getContext($context, "index"), "html", null, true);
        echo "\" value=\"0\" />
\t\t\t\t\t\t<input type=\"hidden\" data-index=\"";
        // line 19
        echo twig_escape_filter($this->env, $this->getContext($context, "index"), "html", null, true);
        echo "\" class=\"redirect-id\" id=\"form-redirect-id-";
        echo twig_escape_filter($this->env, $this->getContext($context, "index"), "html", null, true);
        echo "\" value=\"";
...
\t\t\t\t\t\t<a href=\"Javascript:void(0);\" data-index=\"";
        // line 20
        echo twig_escape_filter($this->env, $this->getContext($context, "index"), "html", null, true);
        echo "\" class=\"button ui-button-red action-confirm-delete-redirect\" data-icon-primary=\"ui-icon-closethick\">Delete</a>
\t\t\t\t\t</td>
\t\t\t\t</tr>
\t\t\t</tbody>
\t\t</table>
\t</div>
    ...
    {
        return "WebIlluminationAdminBundle:System:redirect.html.twig";
    }
