...
/* WebIlluminationAdminBundle:System:ajaxGetRedirectsFunctions.js.twig */
class __TwigTemplate_0f88d3d11c55b788f305e10577254546 extends Twig_Template
{
...
\t\t\t    \turl: \"";
        // line 21
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("system_ajax_update_redirect"), "html", null, true);
        echo "\",
\t\t\t      \ttype: \"POST\",
\t\t\t      \tdataType: \"json\",
\t\t\t      \tdata: {
...
\t\t\t      \t\tredirectTo: '";
        // line 29
        echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "routing"), "url"), "html", null, true);
        echo "',
...
\t\$.ajax({
    \turl: \"";
        // line 105
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("system_ajax_add_redirect"), "html", null, true);
        echo "\",
      \ttype: \"GET\",
      \tdata: {
      \t\tid: \$nextElement,
...
\t        \$(\"#ajax_loading\").hide();
   ...
   \t});
    ...
    {
        return "WebIlluminationAdminBundle:System:ajaxGetRedirectsFunctions.js.twig";
    }
