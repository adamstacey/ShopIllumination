...
class __TwigTemplate_327bae103668a3c7a7df0e1ada6e0bdd extends Twig_Template
{
    ...
    {
        // line 1
        echo "<div id=\"product-discounts-container-";
...
\t";
        // line 2
        if ((twig_length_filter($this->env, $this->getContext($context, "productDiscounts")) > 0)) {
            // line 3
...
\t\t\t";
            ...
            $context['_seq'] = twig_ensure_traversable($this->getContext($context, "productDiscounts"));
            foreach ($context['_seq'] as $context["_key"] => $context["productDiscount"]) {
                // line 10
                echo "\t\t\t\t<tr id=\"product-discount-";
                echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "productDiscount"), "productId"), "html", null, true);
                echo "\">
\t\t\t\t\t<td class=\"al\">";
                // line 11
                echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "productDiscount"), "product"), "html", null, true);
                echo "</td>
\t\t\t\t\t<td class=\"ac\">";
                // line 12
                echo twig_escape_filter($this->env, twig_number_format_filter($this->env, $this->getAttribute($this->getContext($context, "productDiscount"), "discount"), 2), "html", null, true);
                echo "</td>
\t\t\t\t\t<td class=\"ac\" width=\"28\"><button data-voucher-code-id=\"";
                ...
                echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "productDiscount"), "productId"), "html", null, true);
                echo "\" class=\"button ui-button-red action-confirm-delete-product-discount\" data-icon-primary=\"ui-icon-closethick\" data-icon-only=\"true\">Delete</button></td>
\t\t\t\t</tr>
\t\t\t";
            }
            $_parent = $context['_parent'];
            unset($context['_seq'], $context['_iterated'], $context['_key'], $context['productDiscount'], $context['_parent'], $context['loop']);
...
\t";
            ...
            // line 18
            echo "\t\t<p class=\"ac\">There are no product discounts setup.</p>
\t";
        }
        // line 20
        echo "</div>
...
\t\t\$(\"#product-discounts-container-";
        // line 23
        echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "voucherCode"), "id"), "html", null, true);
        echo " :checkbox:not(.no-uniform), #product-discounts-container-";
        echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "voucherCode"), "id"), "html", null, true);
        echo " :radio:not(.no-uniform), #product-discounts-container-";
        echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "voucherCode"), "id"), "html", null, true);
        echo " select:not(.no-uniform), #product-discounts-container-";
        echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "voucherCode"), "id"), "html", null, true);
...
\t});
    ...
    {
        return "WebIlluminationAdminBundle:VoucherCodes:ajaxGetProductDiscounts.html.twig";
    }
