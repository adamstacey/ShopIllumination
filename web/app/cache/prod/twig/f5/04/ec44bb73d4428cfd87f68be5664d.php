...
/* WebIlluminationAdminBundle:MembershipCards:listingMembershipCard.html.twig */
class __TwigTemplate_f504ec44bb73d4428cfd87f68be5664d extends Twig_Template
{
    ...
    {
        // line 1
        echo "<div class=\"ui-helper-hidden more-information-detail form\" id=\"membership-card-membership-card-";
        echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "membershipCard"), "id"), "html", null, true);
        echo "\">
\t<div id=\"membership-card-error-message-";
        // line 2
        echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "membershipCard"), "id"), "html", null, true);
        echo "\" class=\"ui-helper-hidden ui-widget message closeable\">
\t    <div class=\"ui-state-error ui-corner-all no-margin\">
\t    \t<span class=\"ui-icon ui-icon-alert\"></span>
\t        <p><strong>ERROR:</strong> <span id=\"membership-card-error-message-text-";
        // line 5
        echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "membershipCard"), "id"), "html", null, true);
        echo "\"></span></p>
\t    </div>
\t</div>
\t<h5 class=\"no-margin-top\">Membership Card</h5>
\t<table width=\"100%\">
\t\t<tr>
\t\t\t<td width=\"25%\" class=\"label\"><label for=\"membership-card-membership-number-";
        // line 11
        echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "membershipCard"), "id"), "html", null, true);
        echo "\"><span class=\"required\">*</span> Membership NUmber:</label></td>
\t\t\t<td width=\"75%\" class=\"no-padding\">
\t\t\t\t<input type=\"text\" id=\"membership-card-membership-number-";
        // line 13
        echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "membershipCard"), "id"), "html", null, true);
...
\t<table width=\"100%\">
\t\t<tr>
\t\t\t<td width=\"25%\" class=\"label\"><label for=\"membership-card-valid-from-date-";
        // line 20
        echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "membershipCard"), "id"), "html", null, true);
        echo "\"><span class=\"required\">*</span> Valid From Date:</label></td>
\t\t\t<td width=\"25%\" class=\"no-padding\">
\t\t\t\t<input type=\"text\" id=\"membership-card-valid-from-date-";
        // line 22
        echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "membershipCard"), "id"), "html", null, true);
        echo "\" data-message=\"Please enter the date you want the membership card to be available from.\" required=\"required\" class=\"no-margin full\" value=\"";
        ...
        echo "\" />
\t\t\t\t<input type=\"hidden\" id=\"membership-card-valid-from-date-formatted-";
        // line 23
        echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "membershipCard"), "id"), "html", null, true);
        echo "\" value=\"";
        echo twig_escape_filter($this->env, twig_date_format_filter($this->env, $this->getAttribute($this->getContext($context, "membershipCard"), "validFromDate"), "Y-m-d"), "html", null, true);
        echo "\" />
\t\t\t</td>
\t\t\t<td width=\"25%\" class=\"label\"><label for=\"membership-card-expiry-date-";
        // line 25
        echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "membershipCard"), "id"), "html", null, true);
        echo "\"><span class=\"required\">*</span> Expiry Date:</label></td>
\t\t\t<td width=\"25%\" class=\"no-padding\">
\t\t\t\t<input type=\"text\" id=\"membership-card-expiry-date-";
        // line 27
        echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "membershipCard"), "id"), "html", null, true);
        echo "\" data-message=\"Please enter the date you want the membership card to expire.\" required=\"required\" class=\"no-margin full\" value=\"";
        ...
        echo "\" />
\t\t\t\t<input type=\"hidden\" id=\"membership-card-expiry-date-formatted-";
        // line 28
        echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "membershipCard"), "id"), "html", null, true);
        echo "\" value=\"";
        echo twig_escape_filter($this->env, twig_date_format_filter($this->env, $this->getAttribute($this->getContext($context, "membershipCard"), "expiryDate"), "Y-m-d"), "html", null, true);
        echo "\" />
\t\t\t</td>
\t\t</tr>
\t</table>
...
\t\t<button data-id=\"";
        // line 33
        echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "membershipCard"), "id"), "html", null, true);
        echo "\" class=\"action-save-membership-card button ui-button-green\" data-icon-primary=\"ui-icon-check\">Save Membership Card</button>
\t\t<div class=\"clear\"></div>
\t</div>
</div>
...
\t\t";
        // line 40
        echo "\t\t\$(\"#membership-card-valid-from-date-";
        echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "membershipCard"), "id"), "html", null, true);
        echo "\").datepicker({
\t\t\tchangeMonth: true,
\t\t\tchangeYear: true,
\t\t\tdateFormat: \"dd/mm/yy\",
\t\t\taltField: \"#membership-card-valid-from-date-formatted-";
        // line 44
        echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "membershipCard"), "id"), "html", null, true);
        echo "\",
\t\t\taltFormat: \"yy-mm-dd\"
...
\t\t\tchangeYear: true,
\t\t\tdateFormat: \"dd/mm/yy\",
\t\t\taltField: \"#membership-card-expiry-date-formatted-";
        // line 51
        echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "membershipCard"), "id"), "html", null, true);
        echo "\",
\t\t\taltFormat: \"yy-mm-dd\"
...
\t});
    ...
    {
        return "WebIlluminationAdminBundle:MembershipCards:listingMembershipCard.html.twig";
    }
