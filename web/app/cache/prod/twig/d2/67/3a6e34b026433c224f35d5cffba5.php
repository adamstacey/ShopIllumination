...
/* WebIlluminationShopBundle:Users:registerScript.js.twig */
class __TwigTemplate_d2673a6e34b026433c224f35d5cffba5 extends Twig_Template
{
...
\t   \t\t\t\turl: \"";
        // line 32
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("users_ajax_check_email_address"), "html", null, true);
        echo "\",
\t   \t\t\t\tbeforeSend: function() {
...
\t   \t\t\t\turl: \"";
        // line 101
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("users_ajax_create_user"), "html", null, true);
        echo "\",
\t   \t\t\t\tbeforeSend: function() {
\t\t\t\t\t\t\$(\"#ajax-loading\").show();
\t\t\t\t\t},
...
\t});\t
    ...
    {
        return "WebIlluminationShopBundle:Users:registerScript.js.twig";
    }
