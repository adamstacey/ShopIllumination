...
class __TwigTemplate_57720a035a9c919deefa94b55a6a312f extends Twig_Template
{
...
\t        \t<button class=\"fl button ui-corner-none ui-corner-tl ui-corner-bl ui-button-green action-view-add\" data-icon-primary=\"ui-icon-plusthick\">Add New Practice Day Registration</button>
\t        \t<button class=\"fl button ui-corner-none ui-corner-tr ui-corner-br ui-button-red action-confirm-deletes\" data-icon-primary=\"ui-icon-closethick\">Delete Selected Practice Day Registrations</button>
\t        </div>
\t        <div class=\"clear\"></div>
\t\t</div>
\t</div>
    ...
    {
        return "WebIlluminationAdminBundle:PracticeDayRegistrations:listingToolbar.html.twig";
    }
