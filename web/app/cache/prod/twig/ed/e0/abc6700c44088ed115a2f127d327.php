...
/* WebIlluminationShopBundle:Departments:index.html copy.twig */
class __TwigTemplate_ede0abc6700c44088ed115a2f127d327 extends Twig_Template
{
...
\t                <h2 id=\"products-found\"><img src=\"";
        ...
        echo "\" border=\"0\" alt=\"Loading\" /> Loading Products&hellip; (0%)</h2>
\t            </header>
\t\t\t\t<section class=\"no-padding-right no-padding-bottom\">
\t\t\t\t\t";
        // line 24
        $context['_parent'] = (array) $context;
        $context['_seq'] = twig_ensure_traversable($this->getAttribute($this->getContext($context, "department"), "products"));
        $context['_iterated'] = false;
        foreach ($context['_seq'] as $context["_key"] => $context["product"]) {
            // line 25
            echo "\t\t\t\t\t\t<div class=\"product ui-helper-hidden\" data-product-id=\"";
            echo twig_escape_filter($this->env, $this->getContext($context, "product"), "html", null, true);
            echo "\" id=\"product-";
            echo twig_escape_filter($this->env, $this->getContext($context, "product"), "html", null, true);
            echo "\"></div>
\t\t\t        ";
...
\t\t\tvar \$totalProducts = ";
        // line 37
        echo twig_escape_filter($this->env, twig_length_filter($this->env, $this->getAttribute($this->getContext($context, "department"), "products")), "html", null, true);
        echo ";
\t\t\tvar \$totalProductsLoaded = 0;
\t\t\tvar \$totalProductErrors = 0;
\t\t\t\$(\".product\").each(function(index) {
\t\t\t\tvar \$productId = \$(this).attr(\"data-product-id\");
\t\t\t\t\$(\"#product-\"+\$productId).load(\"";
        // line 42
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("products_ajax_get_product_listing"), "html", null, true);
        echo "\", { id: \$productId }, function(response, status, xhr) {
\t\t\t\t\tif (status == \"error\")
\t\t\t\t\t{
\t\t\t\t\t\t\$totalProductErrors++;
\t\t\t\t\t} else {
...
\t\t\t\t\t\$(\"#products-found\").html('<img src=\"";
        // line 50
        echo twig_escape_filter($this->env, $this->env->getExtension('assets')->getAssetUrl("bundles/webilluminationshop/images/loaders/ajax-bars-loader.gif"), "html", null, true);
        echo "\" border=\"0\" alt=\"Loading\" /> Loading Products&hellip; ('+\$loadedPercentage+'%)');
...
";
    ...
    {
        return "WebIlluminationShopBundle:Departments:index.html copy.twig";
    }
