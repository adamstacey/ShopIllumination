...
/* WebIlluminationAdminBundle:Brands:updateGeneral.html.twig */
class __TwigTemplate_c86741709115025917d2bacf4c016713 extends Twig_Template
{
...
\t<div class=\"clearfix\">
        ...
        // line 18
        if (($this->getAttribute($this->getAttribute($this->getContext($context, "data"), "brand"), "status") == "a")) {
            echo " checked=\"checked\"";
        }
        echo " /> Active</label> <label><input type=\"radio\" name=\"status\" id=\"form-status-h\" value=\"h\"";
        if (($this->getAttribute($this->getAttribute($this->getContext($context, "data"), "brand"), "status") == "h")) {
            echo " checked=\"checked\"";
        }
        echo " /> Hidden</label> <label><input type=\"radio\" name=\"status\" id=\"form-status-d\" value=\"d\"";
        if (($this->getAttribute($this->getAttribute($this->getContext($context, "data"), "brand"), "status") == "d")) {
            echo " checked=\"checked\"";
        }
        echo " /> Disabled</label></div>
    </div>
\t<div class=\"clearfix\">
        <label for=\"form-brand\" class=\"form-label\"><em>*</em> Name<small>Enter the brand name</small></label>
        <div class=\"form-input\"><input type=\"text\" id=\"form-brand\" required=\"required\" data-message=\"Please enter the name of the brand.\" value=\"";
        // line 22
    ...
    <div class=\"clearfix\">
        ...
        \t<div id=\"logo-image-confirm-delete\" class=\"ui-widget message ui-helper-hidden\">
\t\t\t    <div class=\"ui-state-error ui-corner-all\"> 
\t\t\t        <span class=\"ui-icon ui-icon-help\"></span>
\t\t\t        <p><strong>WARNING:</strong> Are you sure you want to delete the logo?</p>
\t\t\t        <p>
\t\t\t        \t<button data-id=\"";
        // line 32
        echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($this->getContext($context, "data"), "brand"), "logoImageId"), "html", null, true);
        echo "\" id=\"logo-image-confirm-delete-button\" class=\"button ui-button-red action-delete-logo-image\" data-icon-primary=\"ui-icon-closethick\">Confirm Delete</button>
\t\t\t        \t<button id=\"image-cancel-delete-button\" class=\"button ui-button-blue action-cancel-delete-logo-image\">Cancel</button>
\t\t\t        </p>
\t\t\t    </div>
\t\t\t</div>
...
\t\t\t\t\t\t\t        \t";
        // line 70
        if ($this->getAttribute($this->getAttribute($this->getAttribute($this->getContext($context, "data", true), "brand", array(), "any", false, true), "logo", array(), "any", false, true), "thumbnailPath", array(), "any", true, true)) {
            // line 71
            echo "\t\t\t\t\t\t\t\t\t    \t<img id=\"form-logo-image-preview\" alt=\"";
            echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($this->getAttribute($this->getContext($context, "data"), "brand"), "logo"), "title"), "html", null, true);
            echo "\" class=\"thumbnail action-image-popup\"";
            if ($this->getAttribute($this->getAttribute($this->getAttribute($this->getContext($context, "data", true), "brand", array(), "any", false, true), "logo", array(), "any", false, true), "largePath", array(), "any", true, true)) {
                echo " data-image-size-width=\"";
                echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($this->getAttribute($this->getContext($context, "data"), "brand"), "logo"), "largeWidth"), "html", null, true);
                echo "\" data-image-size-height=\"";
                echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($this->getAttribute($this->getContext($context, "data"), "brand"), "logo"), "largeHeight"), "html", null, true);
                echo "\" data-image-large-path=\"";
                echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($this->getAttribute($this->getContext($context, "data"), "brand"), "logo"), "largePath"), "html", null, true);
                echo "?version=";
                echo twig_escape_filter($this->env, twig_date_format_filter($this->env, "now", "dmYHis"), "html", null, true);
                echo "\"";
            }
            echo " src=\"";
            echo twig_escape_filter($this->env, $this->env->getExtension('assets')->getAssetUrl($this->getAttribute($this->getAttribute($this->getAttribute($this->getContext($context, "data"), "brand"), "logo"), "thumbnailPath")), "html", null, true);
            echo "\" height=\"24\" border=\"0\" />
\t\t\t\t\t\t\t        \t";
        } else {
            // line 73
            echo "\t\t\t\t\t\t\t        \t\t<img id=\"form-logo-image-preview\" height=\"30\" src=\"";
...
\t\t\t\t\t\t\t        \t";
        ...
        // line 75
        echo "\t\t\t\t\t\t\t\t\t</td>
\t\t\t\t\t\t\t\t\t<td id=\"delete-logo-image-container\" class=\"ac";
        // line 76
        if (($this->getAttribute($this->getAttribute($this->getContext($context, "data"), "brand"), "logoImageId") == 0)) {
            echo " ui-helper-hidden";
        }
        echo "\" width=\"1\">
\t\t\t\t\t\t\t\t\t\t<button class=\"button ui-button-red action-confirm-delete-logo-image\" data-icon-primary=\"ui-icon-closethick\">Delete</button>
\t\t\t\t\t\t\t\t\t</td>
\t\t\t\t\t\t\t\t</tr>
\t\t\t\t\t\t\t</tbody>
\t\t\t\t\t\t</table>
...
\t\t\t</div>
    ...
    {
        return "WebIlluminationAdminBundle:Brands:updateGeneral.html.twig";
    }
