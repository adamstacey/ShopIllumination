...
class __TwigTemplate_8bd1bf81e3c1f9d89b0f7ae425cd24fa extends Twig_Template
{
    ...
    {
        // line 1
        echo "<section id=\"statistics-visits\">
\t<div id=\"ajax-statistics-visits\">
\t\t<div class=\"ac\">
...
\t\t\t";
   ...
   \t\t\t\turl: \"";
        // line 13
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("brands_ajax_statistics_visits"), "html", null, true);
        echo "/";
        echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "brand"), "id"), "html", null, true);
        echo "\",
   \t\t\t\tsuccess: function(data) {
   \t\t\t\t\t\$(\"#ajax-statistics-visits\").html(data);
   \t\t\t\t}
 \t\t\t});
\t\t});
\t</script>
    ...
    {
        return "WebIlluminationAdminBundle:BrandsOld:sectionStatisticsVisits.html.twig";
    }
