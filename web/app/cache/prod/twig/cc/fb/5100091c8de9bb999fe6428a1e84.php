...
/* WebIlluminationAdminBundle:System:ajaxGetFilesScript.js.twig */
class __TwigTemplate_ccfb5100091c8de9bb999fe6428a1e84 extends Twig_Template
{
...
\t\t";
        // line 12
        echo "\t\t\$(\".action-unselect-all-files\").hide();
...
\t\t";
        // line 31
        echo "\t\t\$(\".action-confirm-delete-files\").hide();
...
\t\t";
        // line 56
        echo "\t\t\$(\".action-add-new-file\").live('click', function() {
\t\t\t\$(\"#files .message\").hide();
\t\t\t\$(\".form-error\").remove();
\t\t\tloadNewFile();
\t\t});
...
\t\t";
        // line 63
        echo "\t\t\$(\".file-display-name, .file-file\").live('change', function() {
\t\t\t\$(\"#form-file-requires-update-\"+\$(this).closest(\"li.file-container\").attr(\"data-index\")).val(\"1\");
\t\t});
\t\t
\t\t";
        // line 68
        echo "\t\t\$(\"#form-files-container\").sortable({
...
\t\t";
        // line 77
        echo "\t\t\$(\".action-update-files-and-leave\").live('click', function() {
\t\t\t\$(\"#files .message\").hide();
\t\t\t\$(\".form-error\").remove();
\t\t\tupdateFiles();
\t\t});
...
\t\t";
        // line 84
        echo "\t\t\$(\".action-update-files\").live('click', function() {
\t\t\t\$(\"#files .message\").hide();
\t\t\t\$(\".form-error\").remove();
...
\t\t";
        // line 92
        echo "\t\t\$(\".action-confirm-delete-file\").live('click', function() {
\t\t\t\$(\"#files .message\").hide();
\t\t\t\$(\".form-error\").remove();
\t\t\t\$(\"#ajax_loading\").show();
...
\t\t";
        // line 125
        echo "\t\t\$(\".action-cancel-delete-file\").live('click', function() {
\t\t\t\$(\"#files .message\").hide();
\t\t\t\$(\".form-error\").remove();
\t\t\t\$(\"#ajax_loading\").show();
\t\t\t\$elementIndex = \$(this).attr(\"data-index\");
...
\t\t    \turl: \"";
        // line 143
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("system_ajax_delete_file"), "html", null, true);
        echo "\",
\t\t      \ttype: \"GET\",
\t\t      \tdataType: \"json\",
\t\t      \tdata: {
...
\t\t";
        // line 184
        echo "\t\t\$(\".action-confirm-delete-files\").live('click', function() {
\t\t\t\$(\"#files .message\").hide();
\t\t\t\$(\".form-error\").remove();
\t\t\t\$(\"#ajax_loading\").show();
...
\t\t";
        // line 219
        echo "\t\t\$(\".action-cancel-delete-files\").live('click', function() {
\t\t\t\$(\"#files .message\").hide();
\t\t\t\$(\".form-error\").remove();
\t\t\t\$(\"#ajax_loading\").show();
...
\t\t";
        // line 228
        echo "\t\t\$(\".action-delete-files\").live('click', function() {
\t\t\t\$(\"#files .message\").hide();
\t\t\t\$(\".form-error\").remove();
\t\t\t\$(\"#ajax_loading\").show();
\t\t\t\$errorOccurred = false;
...
\t";
        // line 362
        $this->env->loadTemplate("WebIlluminationAdminBundle:System:ajaxGetFilesFunctions.js.twig")->display(array_merge($context, array("objectId" => $this->getContext($context, "objectId"), "objectType" => $this->getContext($context, "objectType"), "files" => $this->getContext($context, "files"))));
        // line 363
        echo "</script>";
    }
    ...
    {
        return "WebIlluminationAdminBundle:System:ajaxGetFilesScript.js.twig";
    }
