...
/* WebIlluminationAdminBundle:Brands:listingFilter.html.twig */
class __TwigTemplate_7b966a2476638177dcaefd8353e9e81c extends Twig_Template
{
...
\t\t\t<table width=\"100%\">
\t\t\t\t<tr>
\t\t\t\t\t<td class=\"label\" width=\"15%\"><label>Hide Prices</label></td>
\t\t\t\t\t<td width=\"18%\">
...
\t\t\t\t\t\t<input type=\"hidden\" id=\"filter-hide-prices\" value=\"";
        ...
        echo "\" />
\t\t\t\t\t</td>
\t\t\t\t\t<td class=\"label\" width=\"15%\"><label>Show Prices Out of Hours</label></td>
\t\t\t\t\t<td width=\"18%\">
\t\t\t\t\t\t<div class=\"filter-checkbox\"><input";
        // line 48
        $context['_parent'] = (array) $context;
...
\t\t\t\t\t\t<input type=\"hidden\" id=\"filter-show-prices-out-of-hours\" value=\"";
        ...
        echo "\" />
\t\t\t\t\t</td>
\t\t\t\t\t<td class=\"label\" width=\"15%\"><label>Available to Members</label></td>
\t\t\t\t\t<td width=\"19%\">
\t\t\t\t\t\t<div class=\"filter-checkbox\"><input";
        // line 54
        $context['_parent'] = (array) $context;
...
\t</div>
    ...
    {
        return "WebIlluminationAdminBundle:Brands:listingFilter.html.twig";
    }
