...
class __TwigTemplate_d4ecfc8b80df4ae1f984e778894cd578 extends Twig_Template
{
...
\t<div class=\"clearfix\">
\t\t<div class=\"clearfix\">
\t        <label for=\"form-hide-prices\" class=\"form-label\">Hide Prices<small>Hide prices for this brand?</small></label>
\t        <div class=\"form-input\"><label><input type=\"radio\" name=\"hide-prices\" id=\"form-hide-prices-1\" value=\"1\"";
        // line 6
        if (($this->getAttribute($this->getAttribute($this->getContext($context, "data"), "brand"), "hidePrices") == 1)) {
            echo " checked=\"checked\"";
        }
        echo " /> Yes</label> <label><input type=\"radio\" name=\"hide-prices\" id=\"form-hide-prices-0\" value=\"0\"";
        if (($this->getAttribute($this->getAttribute($this->getContext($context, "data"), "brand"), "hidePrices") == 0)) {
            echo " checked=\"checked\"";
        }
        echo " /> No</label></div>
\t    </div>
...
\t        <div class=\"form-input\"><label><input type=\"radio\" name=\"show-prices-out-of-hours\" id=\"form-show-prices-out-of-hours-1\" value=\"1\"";
        // line 10
        if (($this->getAttribute($this->getAttribute($this->getContext($context, "data"), "brand"), "showPricesOutOfHours") == 1)) {
            echo " checked=\"checked\"";
        }
        echo " /> Yes</label> <label><input type=\"radio\" name=\"show-prices-out-of-hours\" id=\"form-show-prices-out-of-hours-0\" value=\"0\"";
        if (($this->getAttribute($this->getAttribute($this->getContext($context, "data"), "brand"), "showPricesOutOfHours") == 0)) {
            echo " checked=\"checked\"";
        }
        echo " /> No</label></div>
\t    </div>
...
\t        <div class=\"form-input\" id=\"form-membership-card-discount-available\"><label><input type=\"radio\" name=\"membership-card-discount-available\" id=\"form-membership-card-discount-available-1\" value=\"1\"";
        // line 14
        if (($this->getAttribute($this->getAttribute($this->getContext($context, "data"), "brand"), "membershipCardDiscountAvailable") == 1)) {
            echo " checked=\"checked\"";
        }
        ...
        if (($this->getAttribute($this->getAttribute($this->getContext($context, "data"), "brand"), "membershipCardDiscountAvailable") == 0)) {
            echo " checked=\"checked\"";
        }
        echo " /> No</label></div>
\t    </div>
...
\t        <div class=\"form-input\"><input type=\"text\" id=\"form-maximum-membership-card-discount\" name=\"maximum-membership-card-discount\" class=\"decimal\" value=\"";
        // line 18
        echo twig_escape_filter($this->env, twig_number_format_filter($this->env, $this->getAttribute($this->getAttribute($this->getContext($context, "data"), "brand"), "maximumMembershipCardDiscount"), 2), "html", null, true);
        echo "\" /></div>
\t    </div>
\t    <div class=\"clearfix\">
...
\t</div>
    ...
    {
        return "WebIlluminationAdminBundle:Brands:updatePrices.html.twig";
    }
