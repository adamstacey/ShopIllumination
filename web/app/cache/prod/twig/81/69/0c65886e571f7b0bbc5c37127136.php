...
/* WebIlluminationAdminBundle:System:contactNumber.html.twig */
class __TwigTemplate_81690c65886e571f7b0bbc5c37127136 extends Twig_Template
{
    ...
    {
        // line 1
        echo "<li class=\"contact-number-container\" data-contact-id=\"";
...
\t\t\t\t\t\t<input data-contact-id=\"";
        ...
        echo "\" data-index=\"";
        echo twig_escape_filter($this->env, $this->getContext($context, "index"), "html", null, true);
        echo "\" type=\"checkbox\" class=\"contact-number-field contact-number-select\" id=\"form-contact-number-select-";
        echo twig_escape_filter($this->env, $this->getContext($context, "contactId"), "html", null, true);
        echo "-";
        echo twig_escape_filter($this->env, $this->getContext($context, "index"), "html", null, true);
        echo "\" value=\"1\" />
...
\t\t\t\t\t\t<select data-contact-id=\"";
        ...
        echo "\" data-index=\"";
        echo twig_escape_filter($this->env, $this->getContext($context, "index"), "html", null, true);
        echo "\" autocomplete=\"off\" class=\"contact-number-field contact-number-contact-number-type-id full\" id=\"form-contact-number-contact-number-type-id-";
        echo twig_escape_filter($this->env, $this->getContext($context, "contactId"), "html", null, true);
        echo "-";
        echo twig_escape_filter($this->env, $this->getContext($context, "index"), "html", null, true);
        echo "\">
...
\t\t\t        \t\t";
        ...
        $context['_seq'] = twig_ensure_traversable($this->getContext($context, "contactNumberTypes"));
        foreach ($context['_seq'] as $context["_key"] => $context["contactNumberType"]) {
            // line 16
            echo "\t\t                \t\t<option value=\"";
            echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "contactNumberType"), "id"), "html", null, true);
            echo "\"";
            if ($this->getAttribute($this->getContext($context, "data", true), "contactNumberTypeId", array(), "any", true, true)) {
                if (($this->getAttribute($this->getContext($context, "contactNumberType"), "id") == $this->getAttribute($this->getContext($context, "data"), "contactNumberTypeId"))) {
                    echo " selected=\"selected\"";
                }
            }
            echo ">";
            echo $this->getAttribute($this->getContext($context, "contactNumberType"), "contactNumberType");
            echo "</option>
\t\t            \t\t";
        }
        $_parent = $context['_parent'];
        unset($context['_seq'], $context['_iterated'], $context['_key'], $context['contactNumberType'], $context['_parent'], $context['loop']);
...
\t\t\t        \t<input data-contact-id=\"";
        ...
        echo "\" data-index=\"";
        echo twig_escape_filter($this->env, $this->getContext($context, "index"), "html", null, true);
        echo "\" type=\"text\" class=\"contact-number-field contact-number-number full integer\" placeholder=\"Number\" id=\"form-contact-number-number-";
        echo twig_escape_filter($this->env, $this->getContext($context, "contactId"), "html", null, true);
        echo "-";
        echo twig_escape_filter($this->env, $this->getContext($context, "index"), "html", null, true);
        echo "\" value=\"";
        if ($this->getAttribute($this->getContext($context, "data", true), "number", array(), "any", true, true)) {
            echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "data"), "number"), "html", null, true);
        }
        echo "\" />
\t\t\t\t\t</td>
\t\t\t\t\t<td width=\"1\">
\t\t\t\t\t\t<input type=\"hidden\" class=\"contact-number-display-order\" id=\"form-contact-number-display-order-";
        // line 24
        echo twig_escape_filter($this->env, $this->getContext($context, "contactId"), "html", null, true);
        echo "-";
        echo twig_escape_filter($this->env, $this->getContext($context, "index"), "html", null, true);
...
\t\t\t\t\t\t<input type=\"hidden\" data-contact-id=\"";
        ...
        echo "\" data-index=\"";
        echo twig_escape_filter($this->env, $this->getContext($context, "index"), "html", null, true);
        echo "\" class=\"contact-number-requires-update\" id=\"form-contact-number-requires-update-";
        echo twig_escape_filter($this->env, $this->getContext($context, "contactId"), "html", null, true);
        echo "-";
        echo twig_escape_filter($this->env, $this->getContext($context, "index"), "html", null, true);
        echo "\" value=\"0\" />
\t\t\t\t\t\t<input type=\"hidden\" data-contact-id=\"";
        ...
        echo "\" data-index=\"";
        echo twig_escape_filter($this->env, $this->getContext($context, "index"), "html", null, true);
        echo "\" class=\"contact-number-id\" id=\"form-contact-number-id-";
        echo twig_escape_filter($this->env, $this->getContext($context, "contactId"), "html", null, true);
        echo "-";
        echo twig_escape_filter($this->env, $this->getContext($context, "index"), "html", null, true);
        echo "\" value=\"";
...
\t\t\t\t\t\t<button data-contact-id=\"";
        ...
        echo "\" data-index=\"";
        echo twig_escape_filter($this->env, $this->getContext($context, "index"), "html", null, true);
        echo "\" class=\"button ui-button-red action-confirm-delete-contact-number\" data-icon-primary=\"ui-icon-closethick\" data-icon-only=\"true\">Delete</button>
\t\t\t\t\t</td>
\t\t\t\t</tr>
\t\t\t</tbody>
\t\t</table>
\t</div>
    ...
    {
        return "WebIlluminationAdminBundle:System:contactNumber.html.twig";
    }
