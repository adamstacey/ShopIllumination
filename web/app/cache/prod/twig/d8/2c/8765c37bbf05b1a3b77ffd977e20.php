...
class __TwigTemplate_d82c8765c37bbf05b1a3b77ffd977e20 extends Twig_Template
{
...
\t\t\t<option";
        // line 5
        if (($this->getAttribute($this->getContext($context, "settings"), "listingSortOrder") == "bd.brand:ASC")) {
            echo " selected=\"selected\"";
        }
        echo " value=\"bd.brand:ASC\">Alphabetically: A-Z</option>
\t\t\t<option";
        // line 6
        if (($this->getAttribute($this->getContext($context, "settings"), "listingSortOrder") == "bd.brand:DESC")) {
            echo " selected=\"selected\"";
        }
        echo " value=\"bd.brand:DESC\">Alphabetically: Z-A</option>
\t\t\t<option";
        // line 7
        if (($this->getAttribute($this->getContext($context, "settings"), "listingSortOrder") == "b.createdAt:DESC")) {
            echo " selected=\"selected\"";
        }
        echo " value=\"b.createdAt:DESC\">Latest</option>
\t\t</select>
\t</div>
    <div class=\"fr\">
...
\t</div>
    ...
    {
        return "WebIlluminationAdminBundle:Brands:listingSettings.html.twig";
    }
