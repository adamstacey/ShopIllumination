...
class __TwigTemplate_8ad3e6bc3395380481be79af5bad4abd extends Twig_Template
{
...
\t\t<div class=\"grid_6\">
        ...
        echo "</h2>
                ...
                <section>
                \t<p class=\"no-margin-top\"><strong>Sorry, there was a problem placing your order. No money has been taken from your card. Please try again or <a href=\"";
        // line 14
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("content_contact_us"), "html", null, true);
        echo "\">contact us</a> if you have any questions.</strong></p>
                \t";
        // line 15
        if ((($this->getAttribute($this->getContext($context, "order"), "paymentType") == "PayPal through SagePay") || ($this->getAttribute($this->getContext($context, "order"), "paymentType") == "SagePay"))) {
            // line 16
            echo "                \t\t<div class=\"info-message ui-status-error\">
...
\t\t\t\t\t\t<a href=\"";
        ...
        echo "\" data-icon-primary=\"ui-icon-locked\" class=\"fr action-pay-securely-now button ui-button-green\">Try Securely Paying Again</a>
...
";
    ...
    {
        return "WebIlluminationShopBundle:Checkout:orderFailed.html.twig";
    }
