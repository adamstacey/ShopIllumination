...
/* WebIlluminationAdminBundle:MembershipCards:ajaxGetCustomer.html.twig */
class __TwigTemplate_01ab01cf8a3157eabc154353d2b0ceed extends Twig_Template
{
...
\t\t<td rowspan=\"5\" width=\"20%\" class=\"uppercase\">";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["address"]) {
            // line 8
            echo "\t\t\t\t";
            if (($this->getAttribute($this->getContext($context, "address"), "contactAddressTypeId") == 4)) {
                // line 9
                echo "\t\t\t\t\t";
...
\t\t\t\t\t";
                // line 10
                if (($this->getAttribute($this->getContext($context, "address"), "organisationName") != "")) {
                    // line 11
                    echo "\t\t\t\t\t\t";
                    echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "address"), "organisationName"), "html", null, true);
                    echo "<br />
\t\t\t\t\t";
                }
                // line 13
...
\t\t<td rowspan=\"5\" width=\"20%\" class=\"uppercase\">";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["address"]) {
            // line 30
            echo "\t\t\t\t";
            if (($this->getAttribute($this->getContext($context, "address"), "contactAddressTypeId") == 5)) {
                // line 31
                echo "\t\t\t\t\t";
                echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "address"), "displayName"), "html", null, true);
                echo "<br />
...
\t\t<td width=\"20%\">";
        ...
        $context['_iterated'] = false;
        foreach ($context['_seq'] as $context["_key"] => $context["emailAddresses"]) {
            // line 54
            echo "\t\t\t\t";
            if (($this->getAttribute($this->getContext($context, "emailAddresses"), "contactEmailAddressTypeId") == 5)) {
                // line 55
                echo "\t\t\t\t\t<a class=\"lowercase\" href=\"mailto:";
                echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "emailAddresses"), "email"), "html", null, true);
                echo "\">";
                echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "emailAddresses"), "displayName"), "html", null, true);
                echo "</a>
\t\t\t\t";
            }
            // line 57
...
\t\t\t";
        ...
        $_parent = $context['_parent'];
        unset($context['_seq'], $context['_iterated'], $context['_key'], $context['emailAddresses'], $context['_parent'], $context['loop']);
        $context = array_merge($_parent, array_intersect_key($context, $_parent));
        // line 60
        echo "\t\t";
        echo trim(preg_replace('/>\s+</', '><', ob_get_clean()));
...
\t\t<td width=\"20%\">";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["number"]) {
            // line 66
            echo "\t\t\t\t";
            if (($this->getAttribute($this->getContext($context, "number"), "contactNumberTypeId") == 5)) {
                echo twig_escape_filter($this->env, (($this->getAttribute($this->getContext($context, "number", true), "number", array(), "any", true, true)) ? (_twig_default_filter($this->getAttribute($this->getContext($context, "number", true), "number"), "-")) : ("-")), "html", null, true);
            }
            // line 67
            echo "\t\t\t";
            $context['_iterated'] = true;
...
\t\t<td width=\"20%\">";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["number"]) {
            // line 76
            echo "\t\t\t\t";
            if (($this->getAttribute($this->getContext($context, "number"), "contactNumberTypeId") == 6)) {
                echo twig_escape_filter($this->env, (($this->getAttribute($this->getContext($context, "number", true), "number", array(), "any", true, true)) ? (_twig_default_filter($this->getAttribute($this->getContext($context, "number", true), "number"), "-")) : ("-")), "html", null, true);
            }
            // line 77
            echo "\t\t\t";
...
\t\t<td width=\"20%\">";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["number"]) {
            // line 86
            echo "\t\t\t\t";
            if (($this->getAttribute($this->getContext($context, "number"), "contactNumberTypeId") == 2)) {
                echo twig_escape_filter($this->env, (($this->getAttribute($this->getContext($context, "number", true), "number", array(), "any", true, true)) ? (_twig_default_filter($this->getAttribute($this->getContext($context, "number", true), "number"), "-")) : ("-")), "html", null, true);
            }
            // line 87
            echo "\t\t\t";
...
\t</tr>
    ...
    {
        return "WebIlluminationAdminBundle:MembershipCards:ajaxGetCustomer.html.twig";
    }
