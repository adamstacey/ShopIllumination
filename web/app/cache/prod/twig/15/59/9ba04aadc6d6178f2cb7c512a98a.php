...
/* WebIlluminationAdminBundle:Products:add.html.twig */
class __TwigTemplate_15599ba04aadc6d6178f2cb7c512a98a extends Twig_Template
{
...
";
    ...
    public function block_body($context, array $blocks = array())
    {
        ...
        echo "\">
\t\t\t\t\t\t <div class=\"clearfix\">
\t\t\t\t\t        <label for=\"form-brand-id\" class=\"form-label\"><em>*</em> Brand<small>Select a brand of the ";
        // line 27
...
\t\t\t\t\t\t\t\t\t<tr>
\t\t\t\t\t\t\t\t\t\t<td>
\t\t\t\t\t\t\t\t\t\t\t<select id=\"form-brand-id\" name=\"brand-id\" class=\"no-margin full\" required=\"required\" data-message=\"Please select the brand of the ";
        // line 32
        echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "settings"), "singleItemDescription"), "html", null, true);
        echo ".\">
...
\t\t\t\t\t    </div>
\t\t\t\t\t    <div class=\"clearfix\">
\t\t\t\t\t        <label for=\"form-brand-id\" class=\"form-label\"><em>*</em> Department<small>Select a department of the ";
        // line 51
        echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "settings"), "singleItemDescription"), "html", null, true);
        echo "</small></label>
\t\t\t\t\t        <div class=\"form-input\">
...
\t\t\t\t\t\t\t\t\t<tr>
\t\t\t\t\t\t\t\t\t\t<td>
\t\t\t\t\t\t\t\t\t\t\t<select id=\"form-department-id\" name=\"department-id\" class=\"no-margin full\" required=\"required\" data-message=\"Please select the department of the ";
        // line 56
        echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "settings"), "singleItemDescription"), "html", null, true);
        echo ".\">
\t\t\t\t\t\t\t\t\t\t\t\t<option value=\"\">- Please Select -</option>
...
\t\t\t\t\t\t\t\t\t\t<p>Please DO NOT add the Brand or Department information to the ";
        // line 79
        echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "settings"), "singleItemDescription"), "html", null, true);
        echo " name.</p>
\t\t\t\t\t\t\t\t\t</div>
...
\t\t\t\t\t    </div>
\t\t\t\t\t\t<div class=\"clearfix\">
\t\t\t\t\t        <label for=\"form-product\" class=\"form-label\"><em>*</em> Name<small>Enter the ";
        // line 85
        echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "settings"), "singleItemDescription"), "html", null, true);
        echo " name</small></label>
\t\t\t\t\t        <div class=\"form-input\"><input type=\"text\" id=\"form-";
        // line 86
        echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "settings"), "singleItemDescription"), "html", null, true);
        echo "\" name=\"product\" required=\"required\" data-message=\"Please enter the name of the ";
        echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "settings"), "singleItemDescription"), "html", null, true);
        echo ".\" value=\"\" /></div>
\t\t\t\t\t    </div>
\t\t\t\t\t    <div class=\"clearfix\">
\t\t\t\t\t        <label for=\"form-product-code\" class=\"form-label\"><em>*</em> Product Code<small>Enter your own unique ";
        // line 89
        echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "settings"), "singleItemDescription"), "html", null, true);
        echo " code</small></label>
\t\t\t\t\t        <div class=\"form-input\"><input type=\"text\" id=\"form-product-code\" name=\"product-code\" class=\"uppercase\" required=\"required\" data-message=\"Please enter the code of the ";
        // line 90
        echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "settings"), "singleItemDescription"), "html", null, true);
        echo ".\" value=\"\" /></div>
\t\t\t\t\t    </div>
...
\t";
    ...
    {
        return "WebIlluminationAdminBundle:Products:add.html.twig";
    }
