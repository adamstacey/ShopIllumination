...
class __TwigTemplate_4cd666f0c6c482e1738c0bf8a0b67fcf extends Twig_Template
{
    ...
    {
        echo "Ride Direct Privilege Discount Card | ";
    ...
    {
        // line 4
        echo "\t<meta name=\"description\" content=\"Enjoy the benefits of the Ride Direct Privilege Card. 10% ongoing discount, Kawasaki test days, savings, free stickers and much more.\">
\t<meta name=\"keywords\" content=\"ride direct, privilege card, test days, kawasaki, discount, savings, membership, member, card, offers, discount codes, voucher codes, benefits\">
";
    }
...
\t\t\t\t\t\t<img src=\"";
        // line 13
        echo twig_escape_filter($this->env, $this->env->getExtension('assets')->getAssetUrl("/bundles/webilluminationshop/images/headers/join-the-club.jpg"), "html", null, true);
        echo "\" alt=\"Join the Club!\" />
\t\t\t\t\t\t<h3 class=\"right\">Join the Club!</h3>
\t\t\t\t\t\t<div class=\"slogan right\"><img width=\"500\" height=\"60\" src=\"";
        // line 15
        echo twig_escape_filter($this->env, $this->env->getExtension('assets')->getAssetUrl("/bundles/webilluminationshop/images/logos/ride-direct-slogan-white.png"), "html", null, true);
        echo "\" alt=\"Committed to giving riders more…\" /></div>
\t\t\t\t\t</div>
\t\t\t\t</div>
\t\t\t</div>
\t\t</header>
...
";
    ...
    public function block_body($context, array $blocks = array())
    {
        // line 23
        echo "\t<header>
\t\t<h1>Enjoy the Benefits of the Ride Direct Privilege Discount Card</h1>
\t</header>
\t<section class=\"container_6 clearfix\">
\t\t<div class=\"grid_4\"> 
\t\t\t<div class=\"portlet\">
\t\t\t\t<header>
\t                <h2>What benefits do I receive with my card?</h2>
\t            </header>
\t\t\t\t<section id=\"privelege-card-benefits\">
\t\t\t\t\t<div class=\"clearfix\">
\t\t\t\t\t\t<img class=\"fr\" src=\"";
        // line 34
        echo twig_escape_filter($this->env, $this->env->getExtension('assets')->getAssetUrl("/bundles/webilluminationshop/images/privilege-card.png"), "html", null, true);
        echo "\" alt=\"Ride Direct Privilege Card\" />
\t\t\t\t\t\t<ul class=\"no-margin-bottom\">
\t\t\t\t\t\t\t<li>10% Ongoing Discount Off Parts, Gear & Accessories (Off RRP price)</li>
\t\t\t\t\t\t\t<li>Big Discounts Off New Kawasaki Motocross & Enduro Bikes</li>
\t\t\t\t\t\t\t<li>Kawasaki Test Days</li>
\t\t\t\t\t\t\t<li>Savings at <a target=\"_blank\" href=\"http://www.stalkermx.com/\">Stalker MX Practice Track</a></li>
\t\t\t\t\t\t\t";
        // line 41
        echo "\t\t\t\t\t\t\t<li>Monthly Exclusive Members Online Offers</li>
\t\t\t\t\t\t\t<li>Free Stickers</li>
\t\t\t\t\t\t\t<li>£50 Online Discount Vouchers</li>
\t\t\t\t\t\t\t<li>More Members Benefit's &amp; Savings Coming Soon...</li>
\t\t\t\t\t\t</ul>
\t\t\t\t\t</div>
\t\t\t\t</section>
\t        </div>
...
\t            </header>
\t\t\t\t<section id=\"privelege-card-get-now\">
\t\t\t\t\t<div class=\"clearfix\">
...
\t\t\t\t\t\t<a target=\"_blank\" href=\"http://www.kawasaki.co.uk/\"><img src=\"";
        // line 80
        echo twig_escape_filter($this->env, $this->env->getExtension('assets')->getAssetUrl("/bundles/webilluminationshop/images/logos/kawasaki-logo.jpg"), "html", null, true);
        echo "\" alt=\"Kawasaki\" /></a>
\t\t\t\t\t\t<a target=\"_blank\" href=\"http://www.stalkermx.com/\"><img src=\"";
        // line 81
        echo twig_escape_filter($this->env, $this->env->getExtension('assets')->getAssetUrl("/bundles/webilluminationshop/images/logos/stalker-mx-logo.jpg"), "html", null, true);
        echo "\" alt=\"Stalker MX\" /></a>
\t\t\t\t\t\t";
        // line 83
        echo "\t\t\t\t\t</div>
\t\t\t\t</section>
...
\t\t\t\$(\"#privelege-card-get-now\").height(\$(\"#privelege-card-benefits\").height());
\t\t\t";
        // line 96
...
";
    ...
    {
        return "WebIlluminationShopBundle:Content:privilegeCard.html.twig";
    }
