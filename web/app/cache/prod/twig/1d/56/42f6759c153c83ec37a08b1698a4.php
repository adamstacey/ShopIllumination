...
class __TwigTemplate_1d5642f6759c153c83ec37a08b1698a4 extends Twig_Template
{
    ...
    {
        // line 1
        echo "<div id=\"brand-discounts-container-";
...
\t";
        // line 2
        if ((twig_length_filter($this->env, $this->getContext($context, "brandDiscounts")) > 0)) {
            // line 3
...
\t\t\t";
            ...
            $context['_seq'] = twig_ensure_traversable($this->getContext($context, "brandDiscounts"));
            foreach ($context['_seq'] as $context["_key"] => $context["brandDiscount"]) {
                // line 10
                echo "\t\t\t\t<tr id=\"brand-discount-";
                echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "brandDiscount"), "brandId"), "html", null, true);
                echo "\">
\t\t\t\t\t<td class=\"al\">";
                // line 11
                echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "brandDiscount"), "brand"), "html", null, true);
                echo "</td>
\t\t\t\t\t<td class=\"ac\">";
                // line 12
                echo twig_escape_filter($this->env, twig_number_format_filter($this->env, $this->getAttribute($this->getContext($context, "brandDiscount"), "discount"), 2), "html", null, true);
                echo "</td>
\t\t\t\t\t<td class=\"ac\" width=\"28\"><button data-voucher-code-id=\"";
                ...
                echo "\" data-brand-id=\"";
                echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "brandDiscount"), "brandId"), "html", null, true);
                echo "\" class=\"button ui-button-red action-confirm-delete-brand-discount\" data-icon-primary=\"ui-icon-closethick\" data-icon-only=\"true\">Delete</button></td>
\t\t\t\t</tr>
\t\t\t";
            }
            $_parent = $context['_parent'];
            unset($context['_seq'], $context['_iterated'], $context['_key'], $context['brandDiscount'], $context['_parent'], $context['loop']);
...
\t";
            ...
            // line 18
            echo "\t\t<p class=\"ac\">There are no brand discounts setup.</p>
\t";
        }
        // line 20
        echo "</div>
...
\t\t\$(\"#brand-discounts-container-";
        // line 23
        echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "voucherCode"), "id"), "html", null, true);
        echo " :checkbox:not(.no-uniform), #brand-discounts-container-";
        echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "voucherCode"), "id"), "html", null, true);
        echo " :radio:not(.no-uniform), #brand-discounts-container-";
        echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "voucherCode"), "id"), "html", null, true);
        echo " select:not(.no-uniform), #brand-discounts-container-";
        echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "voucherCode"), "id"), "html", null, true);
...
\t});
    ...
    {
        return "WebIlluminationAdminBundle:VoucherCodes:ajaxGetBrandDiscounts.html.twig";
    }
