...
/* WebIlluminationAdminBundle:System:ajaxGetContactWebAddresses.html.twig */
class __TwigTemplate_e801fff9234cc7172c6c7b9a793316e8 extends Twig_Template
{
    ...
    {
        // line 1
        echo "<div id=\"contact-web-address-success-message-";
    ...
    \t<span class=\"ui-icon ui-icon-circle-check\"></span>
        <p><strong>SUCCESS:</strong> <span id=\"contact-web-address-success-message-text-";
        // line 4
        echo twig_escape_filter($this->env, $this->getContext($context, "contactId"), "html", null, true);
        echo "\"></span></p>
    </div>
</div>
<div id=\"contact-web-address-error-message-";
        // line 7
        echo twig_escape_filter($this->env, $this->getContext($context, "contactId"), "html", null, true);
        echo "\" class=\"ui-widget message closeable ui-helper-hidden\">
    <div class=\"ui-state-error ui-corner-all\">
    \t<span class=\"ui-icon ui-icon-alert\"></span>
        <p><strong>ERROR:</strong> <span id=\"contact-web-address-error-message-text-";
        // line 10
        echo twig_escape_filter($this->env, $this->getContext($context, "contactId"), "html", null, true);
        echo "\"></span></p>
    </div>
</div>
<div id=\"contact-web-address-confirm-delete-";
        // line 13
        echo twig_escape_filter($this->env, $this->getContext($context, "contactId"), "html", null, true);
        echo "\" class=\"ui-widget message ui-helper-hidden\">
    <div class=\"ui-state-error ui-corner-all\"> 
        <span class=\"ui-icon ui-icon-help\"></span>
        <p><strong>WARNING:</strong> Are you sure you want to delete the highlighted contact web address?</p>
        <p>
        \t<button data-contact-id=\"";
        // line 18
        echo twig_escape_filter($this->env, $this->getContext($context, "contactId"), "html", null, true);
        echo "\" data-index=\"\" id=\"contact-web-address-confirm-delete-button-";
        echo twig_escape_filter($this->env, $this->getContext($context, "contactId"), "html", null, true);
        echo "\" class=\"button ui-button-red action-delete-contact-web-address\" data-icon-primary=\"ui-icon-closethick\">Confirm Delete</button>
        \t<button data-contact-id=\"";
        // line 19
        echo twig_escape_filter($this->env, $this->getContext($context, "contactId"), "html", null, true);
        echo "\" data-index=\"\" id=\"contact-web-address-cancel-delete-button-";
        echo twig_escape_filter($this->env, $this->getContext($context, "contactId"), "html", null, true);
        echo "\" class=\"button ui-button-blue action-cancel-delete-contact-web-address\">Cancel</button>
        </p>
    </div>
</div>
<div id=\"contact-web-address-confirm-deletes-";
        // line 23
        echo twig_escape_filter($this->env, $this->getContext($context, "contactId"), "html", null, true);
        echo "\" class=\"ui-widget message ui-helper-hidden\">
    <div class=\"ui-state-error ui-corner-all\">
    \t<span class=\"ui-icon ui-icon-help\"></span>
        <p><strong>WARNING:</strong> Are you sure you want to delete the selected contact web addresses?</p>
        <p>
        \t<button data-contact-id=\"";
        // line 28
        echo twig_escape_filter($this->env, $this->getContext($context, "contactId"), "html", null, true);
        echo "\" id=\"contact-web-address-confirm-deletes-button-";
        echo twig_escape_filter($this->env, $this->getContext($context, "contactId"), "html", null, true);
        echo "\" class=\"button ui-button-red action-delete-contact-web-addresses\" data-icon-primary=\"ui-icon-closethick\">Confirm Delete</button>
        \t<button data-contact-id=\"";
        // line 29
        echo twig_escape_filter($this->env, $this->getContext($context, "contactId"), "html", null, true);
        echo "\" id=\"contact-web-address-cancel-deletes-button-";
        echo twig_escape_filter($this->env, $this->getContext($context, "contactId"), "html", null, true);
        echo "\" class=\"button ui-button-blue action-cancel-delete-contact-web-addresses\">Cancel</button>
        </p>
    </div>
</div>
<div class=\"clearfix\">
    <div class=\"form-input-long\">
\t\t<div class=\"contact-web-addresses-container\">
\t\t\t<input type=\"hidden\" id=\"contact-web-address-count-";
        // line 36
        echo twig_escape_filter($this->env, $this->getContext($context, "contactId"), "html", null, true);
        echo "\" value=\"";
        if ((twig_length_filter($this->env, $this->getContext($context, "contactWebAddresses")) > 1)) {
            echo twig_escape_filter($this->env, twig_length_filter($this->env, $this->getContext($context, "contactWebAddresses")), "html", null, true);
        } else {
            echo "1";
        }
        echo "\" />
\t\t\t<ul class=\"list-fields contact-web-addresses-container\" id=\"form-contact-web-addresses-container-";
        // line 37
        echo twig_escape_filter($this->env, $this->getContext($context, "contactId"), "html", null, true);
        echo "\">
\t\t\t\t";
        ...
        $context['_seq'] = twig_ensure_traversable($this->getContext($context, "contactWebAddresses"));
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["contactWebAddress"]) {
            // line 39
            echo "\t\t\t\t\t";
            $this->env->loadTemplate("WebIlluminationAdminBundle:System:contactWebAddress.html.twig")->display(array_merge($context, array("contactId" => $this->getContext($context, "contactId"), "index" => $this->getAttribute($this->getContext($context, "loop"), "index"), "data" => $this->getContext($context, "contactWebAddress"), "contactWebAddressTypes" => $this->getContext($context, "contactWebAddressTypes"))));
            // line 40
            echo "\t\t\t    ";
        ...
        if (!$context['_iterated']) {
            // line 41
            echo "\t\t\t    \t";
            $this->env->loadTemplate("WebIlluminationAdminBundle:System:contactWebAddress.html.twig")->display(array_merge($context, array("contactId" => $this->getContext($context, "contactId"), "index" => "1", "contactWebAddressTypes" => $this->getContext($context, "contactWebAddressTypes"))));
            // line 42
            echo "\t\t\t\t";
        }
...
<div class=\"clearfix\">
    ...
    \t<button data-contact-id=\"";
        // line 49
        echo twig_escape_filter($this->env, $this->getContext($context, "contactId"), "html", null, true);
        echo "\" class=\"button ui-button-green action-update-contact-web-addresses\" data-icon-primary=\"ui-icon-check\">Update</button>
    \t<button data-contact-id=\"";
        // line 50
        echo twig_escape_filter($this->env, $this->getContext($context, "contactId"), "html", null, true);
        echo "\" class=\"button ui-button-red action-confirm-delete-contact-web-addresses ui-helper-hidden\" data-icon-primary=\"ui-icon-closethick\">Delete</button>
    \t<button data-contact-id=\"";
        // line 51
        echo twig_escape_filter($this->env, $this->getContext($context, "contactId"), "html", null, true);
        echo "\" class=\"button ui-button-blue action-add-new-contact-web-address\" data-icon-primary=\"ui-icon-plusthick\">Add</button>
    \t<button data-contact-id=\"";
        // line 52
        echo twig_escape_filter($this->env, $this->getContext($context, "contactId"), "html", null, true);
        echo "\" class=\"button ui-button-blue action-select-all-contact-web-addresses\" data-icon-primary=\"ui-icon-radio-on\">Select All</button>
    \t<button data-contact-id=\"";
        // line 53
        echo twig_escape_filter($this->env, $this->getContext($context, "contactId"), "html", null, true);
        echo "\" class=\"button ui-button-blue action-unselect-all-contact-web-addresses ui-helper-hidden\" data-icon-primary=\"ui-icon-bullet\">Unselect All</button>
    </div>
</div>";
    }
    ...
    {
        return "WebIlluminationAdminBundle:System:ajaxGetContactWebAddresses.html.twig";
    }
