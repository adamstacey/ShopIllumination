...
class __TwigTemplate_eb86006759f96ce54ab81139f6854ec9 extends Twig_Template
{
    ...
    {
        // line 1
        echo "<div class=\"ui-helper-hidden more-information-detail\" id=\"guarantees-";
        echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "item"), "id"), "html", null, true);
        echo "\">
\t<h5 class=\"no-margin-top\">Guarantees</h5>
\t";
        // line 3
        if ((twig_length_filter($this->env, $this->getAttribute($this->getContext($context, "item"), "guarantees")) > 0)) {
            // line 4
            echo "\t\t<div class=\"padding-5\">
\t\t\t";
            // line 5
            $context['_parent'] = (array) $context;
            $context['_seq'] = twig_ensure_traversable($this->getAttribute($this->getContext($context, "item"), "guarantees"));
...
\t";
            ...
            // line 15
            echo "\t\t<p class=\"padding-top-5\">There are currently no standard guarantees setup for <strong>";
...
\t";
    ...
    {
        return "WebIlluminationAdminBundle:Brands:listingGuarantees.html.twig";
    }
