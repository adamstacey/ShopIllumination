...
/* WebIlluminationAdminBundle:Brands:updateScript.js.twig */
class __TwigTemplate_41385ee25fc6bfe86cd1c74f7bbc9af9 extends Twig_Template
{
...
\t";
        ...
        // line 10
        echo "\t";
        $template = $this->env->resolveTemplate((("WebIlluminationAdminBundle:" . $this->getAttribute($this->getContext($context, "settings"), "multipleItemsModel")) . ":updateContactsFunctions.js.twig"));
        $template->display(array_merge($context, array("settings" => $this->getContext($context, "settings"), "data" => $this->getContext($context, "data"))));
        // line 11
        echo "\t";
...
\t\t";
        ...
        // line 20
        echo "\t\t";
        $template = $this->env->resolveTemplate((("WebIlluminationAdminBundle:" . $this->getAttribute($this->getContext($context, "settings"), "multipleItemsModel")) . ":updateContactsScript.js.twig"));
        $template->display(array_merge($context, array("settings" => $this->getContext($context, "settings"), "data" => $this->getContext($context, "data"))));
        // line 21
        echo "\t\t";
...
\t});\t
    ...
    {
        return "WebIlluminationAdminBundle:Brands:updateScript.js.twig";
    }
