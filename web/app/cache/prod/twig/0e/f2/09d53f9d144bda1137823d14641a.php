...
/* WebIlluminationAdminBundle:Departments:updateFiles.html.twig */
class __TwigTemplate_0ef209d53f9d144bda1137823d14641a extends Twig_Template
{
    ...
    {
        // line 1
        echo "<section id=\"files\" class=\"form ui-helper-hidden\">
\t<h2>Files</h2>
\t<div class=\"clearfix\">
\t\t<div id=\"file-loading-error\" class=\"ui-widget message margin-bottom-5 ui-helper-hidden\">
\t\t    <div class=\"ui-state-error no-margin-top ui-corner-all\">
\t\t    \t<span class=\"ui-icon ui-icon-alert\"></span>
\t\t        <p class=\"no-margin\"><strong>ERROR:</strong> Sorry, there was a problem loading the files. Please contact support and advise.</p>
\t\t    </div>
\t\t</div>
\t\t<div id=\"ajax-files-loading\" class=\"ac\">
\t\t\t<p>Loading files, please wait&hellip;</p>
\t\t\t<p><img alt=\"Loading\" width=\"16\" height=\"16\" src=\"";
        ...
        echo "\" /></p>
\t\t</div>
\t\t<div id=\"ajax-files\" class=\"ui-helper-hidden\"></div>
\t</div>
</section>";
    }
    ...
    {
        return "WebIlluminationAdminBundle:Departments:updateFiles.html.twig";
    }
