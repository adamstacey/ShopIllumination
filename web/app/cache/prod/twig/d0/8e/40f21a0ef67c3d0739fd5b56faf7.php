...
class __TwigTemplate_d08e40f21a0ef67c3d0739fd5b56faf7 extends Twig_Template
{
    ...
    {
        echo "UK Call Centre Based in Derby | ";
...
\t\t\t\t\t\t<img src=\"";
        // line 9
        echo twig_escape_filter($this->env, $this->env->getExtension('assets')->getAssetUrl("/bundles/webilluminationshop/images/headers/uk-call-centre.jpg"), "html", null, true);
        echo "\" alt=\"The Ride Direct call centre\" />
\t\t\t\t\t\t<h3 class=\"right\">Speak to a real person</h3>
\t\t\t\t\t</div>
\t\t\t\t</div>
\t\t\t</div>
\t\t</header>
...
";
    ...
    public function block_body($context, array $blocks = array())
    {
        // line 18
        echo "\t<header>
\t\t<h2>Ride Direct UK Call Centre</h2>
\t</header>
\t<section class=\"container_6 clearfix\">
\t\t<div class=\"grid_6\"> 
\t\t\t<div class=\"portlet\">
\t\t\t\t<header>
\t                <h2>UK Call Centre</h2>
\t            </header>
\t\t\t\t<section>
\t\t\t\t\t<div class=\"clearfix\">
...
";
    ...
    {
        return "WebIlluminationShopBundle:Content:ukCallCentre.html.twig";
    }
