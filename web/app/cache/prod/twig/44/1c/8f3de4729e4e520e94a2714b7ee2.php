...
class __TwigTemplate_441c8f3de4729e4e520e94a2714b7ee2 extends Twig_Template
{
    ...
    {
        // line 3
        echo "We received a request to reset the password associated with this email address. If you made this request, please follow the instructions below.

Copy and paste the link below into your browser's address bar, or retype it there:
...
Once you have returned to the Ride Direct site, we will give you instructions on resetting your password.

Ride Drect will never email you and ask you to disclose or verify your Ride Direct password, credit card, or bank account number.

If you receive a suspicious email with a link to update your account information, do not click on the link. Iinstead, report the email to Ride Direct for investigation.
";
        // line 16
    ...
    {
        return "WebIlluminationShopBundle:Security:resetPasswordEmail.txt.twig";
    }
