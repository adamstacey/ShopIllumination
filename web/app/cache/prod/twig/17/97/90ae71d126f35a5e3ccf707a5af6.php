...
class __TwigTemplate_179790ae71d126f35a5e3ccf707a5af6 extends Twig_Template
{
    ...
    {
        // line 1
        echo "<div class=\"ui-helper-hidden more-information-detail\" id=\"membership-card-report-";
        echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "membershipCard"), "id"), "html", null, true);
        echo "\">
\t<h5 class=\"no-margin-top\">Membership Card Usage Report</h5>
\t<table width=\"100%\">
\t\t<tr>
\t\t\t<td class=\"label\" width=\"15%\"><label>Items Purchased</label></td>
\t\t\t<td width=\"15%\">";
        // line 6
        echo twig_escape_filter($this->env, (($this->getAttribute($this->getContext($context, "membershipCard", true), "items", array(), "any", true, true)) ? (_twig_default_filter($this->getAttribute($this->getContext($context, "membershipCard", true), "items"), "0")) : ("0")), "html", null, true);
        echo "</td>
\t\t\t<td class=\"label\" width=\"15%\"><label>Total Spend</label></td>
\t\t\t<td width=\"20%\">&pound;";
        // line 8
        echo twig_escape_filter($this->env, _twig_default_filter(twig_number_format_filter($this->env, $this->getAttribute($this->getContext($context, "membershipCard"), "subTotal"), 2), "0.00"), "html", null, true);
        echo "</td>
\t\t\t<td class=\"label\" width=\"15%\"><label>Savings Made</label></td>
\t\t\t<td width=\"20%\">&pound;";
        // line 10
        echo twig_escape_filter($this->env, _twig_default_filter(twig_number_format_filter($this->env, $this->getAttribute($this->getContext($context, "membershipCard"), "savings"), 2), "0.00"), "html", null, true);
        echo "</td>
\t\t</tr>
\t</table>
</div>";
    ...
    {
        return "WebIlluminationAdminBundle:MembershipCards:listingReport.html.twig";
    }
