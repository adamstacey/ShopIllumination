...
/* WebIlluminationAdminBundle:Products:updateRelatedProductsFunctions.js.twig */
class __TwigTemplate_172c9ef8c733b3bc1d79beded49460c6 extends Twig_Template
{
    ...
    {
        // line 2
        echo "\$(\"#form-related-products-container\").sortable({
...
\t\turl: \"";
        // line 14
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath((("admin_" . $this->getAttribute($this->getContext($context, "settings"), "multipleItemsPath")) . "_ajax_get_related_products")), "html", null, true);
        echo "\",
\t\tbeforeSend: function() {
...
";
        // line 45
        echo "function updateRelatedProducts()
{
\t\$errorOccurred = false;
...
\t\t\t    \turl: \"";
        // line 64
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath((("admin_" . $this->getAttribute($this->getContext($context, "settings"), "multipleItemsPath")) . "_ajax_update_related_product")), "html", null, true);
        echo "\",
\t\t\t      \ttype: \"GET\",
\t\t\t      \tdataType: \"json\",
\t\t\t      \tdata: {
...
";
        // line 139
        echo "function loadNewRelatedProduct()
{
\t\$(\"#ajax_loading\").show();
...
\t\$.ajax({
    \turl: \"";
        // line 145
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath((("admin_" . $this->getAttribute($this->getContext($context, "settings"), "multipleItemsPath")) . "_ajax_add_related_product")), "html", null, true);
        echo "\",
      \ttype: \"GET\",
      \tdata: {
      \t\tid: \$nextElement,
...
";
        // line 178
        echo "function reOrderRelatedProducts()
{
\t\$(\"#related-products .message\").hide();
\t\$(\".form-error\").remove();
...
\t});
    ...
    {
        return "WebIlluminationAdminBundle:Products:updateRelatedProductsFunctions.js.twig";
    }
