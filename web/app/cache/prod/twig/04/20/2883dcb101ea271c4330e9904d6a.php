...
/* WebIlluminationAdminBundle:System:guarantee.html.twig */
class __TwigTemplate_04202883dcb101ea271c4330e9904d6a extends Twig_Template
{
...
\t\t\t\t\t\t<input data-index=\"";
        // line 10
        echo twig_escape_filter($this->env, $this->getContext($context, "index"), "html", null, true);
        echo "\" type=\"checkbox\" class=\"guarantee-select\" id=\"form-guarantee-select-";
        echo twig_escape_filter($this->env, $this->getContext($context, "index"), "html", null, true);
        echo "\" value=\"1\" />
\t\t\t\t\t</td>
\t\t\t\t\t<td>
\t\t\t\t\t\t<select autocomplete=\"off\" required=\"required\" data-message=\"Please select a guarantee type.\" class=\"guarantee-type full\" id=\"form-guarantee-type-id-";
        // line 13
        echo twig_escape_filter($this->env, $this->getContext($context, "index"), "html", null, true);
        echo "\">
...
\t\t\t        \t\t";
        ...
        $context['_seq'] = twig_ensure_traversable($this->getContext($context, "guaranteeTypes"));
        foreach ($context['_seq'] as $context["_key"] => $context["guaranteeType"]) {
            // line 16
            echo "\t\t                \t\t<option value=\"";
            echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "guaranteeType"), "id"), "html", null, true);
            echo "\"";
            if ($this->getAttribute($this->getContext($context, "data", true), "guaranteeTypeId", array(), "any", true, true)) {
                if (($this->getAttribute($this->getContext($context, "guaranteeType"), "id") == $this->getAttribute($this->getContext($context, "data"), "guaranteeTypeId"))) {
                    echo " selected=\"selected\"";
                }
            }
            echo ">";
            echo $this->getAttribute($this->getContext($context, "guaranteeType"), "guaranteeType");
            echo "</option>
\t\t            \t\t";
        }
        $_parent = $context['_parent'];
        unset($context['_seq'], $context['_iterated'], $context['_key'], $context['guaranteeType'], $context['_parent'], $context['loop']);
        $context = array_merge($_parent, array_intersect_key($context, $_parent));
        // line 18
        echo "\t\t\t        \t</select>
\t\t\t\t\t</td>
\t\t\t\t\t<td width=\"140\">
\t\t\t        \t<select autocomplete=\"off\" required=\"required\" data-message=\"Please select a guarantee length.\" class=\"guarantee-length full\" id=\"form-guarantee-length-id-";
        // line 21
        echo twig_escape_filter($this->env, $this->getContext($context, "index"), "html", null, true);
        echo "\">
...
\t\t\t        \t\t";
        // line 23
        $context['_parent'] = (array) $context;
        $context['_seq'] = twig_ensure_traversable($this->getContext($context, "guaranteeLengths"));
        foreach ($context['_seq'] as $context["_key"] => $context["guaranteeLength"]) {
            // line 24
            echo "\t\t                \t\t<option value=\"";
            echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "guaranteeLength"), "id"), "html", null, true);
            echo "\"";
            if ($this->getAttribute($this->getContext($context, "data", true), "guaranteeLengthId", array(), "any", true, true)) {
                if (($this->getAttribute($this->getContext($context, "guaranteeLength"), "id") == $this->getAttribute($this->getContext($context, "data"), "guaranteeLengthId"))) {
                    echo " selected=\"selected\"";
                }
            }
            echo ">";
            echo $this->getAttribute($this->getContext($context, "guaranteeLength"), "guaranteeLength");
            echo "</option>
\t\t            \t\t";
        }
        $_parent = $context['_parent'];
        unset($context['_seq'], $context['_iterated'], $context['_key'], $context['guaranteeLength'], $context['_parent'], $context['loop']);
        $context = array_merge($_parent, array_intersect_key($context, $_parent));
        // line 26
        echo "\t\t\t        \t</select>
\t\t\t\t\t</td>
...
\t\t\t\t\t\t<input type=\"hidden\" data-index=\"";
        // line 31
        echo twig_escape_filter($this->env, $this->getContext($context, "index"), "html", null, true);
        echo "\" class=\"guarantee-id\" id=\"form-guarantee-id-";
        echo twig_escape_filter($this->env, $this->getContext($context, "index"), "html", null, true);
        echo "\" value=\"";
...
\t\t\t\t\t\t<button data-index=\"";
        // line 32
        echo twig_escape_filter($this->env, $this->getContext($context, "index"), "html", null, true);
        echo "\" class=\"button ui-button-red action-confirm-delete-guarantee\" data-icon-primary=\"ui-icon-closethick\">Delete</button>
\t\t\t\t\t</td>
\t\t\t\t</tr>
\t\t\t</tbody>
\t\t</table>
\t</div>
    ...
    {
        return "WebIlluminationAdminBundle:System:guarantee.html.twig";
    }
