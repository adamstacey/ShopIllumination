...
class __TwigTemplate_043cc6705d76fa3aa758c2df0ede8a77 extends Twig_Template
{
    ...
    {
        // line 1
        echo "<div id=\"membership-card-add\" class=\"form no-padding-bottom listing-filter ui-helper-hidden\">
\t<h4>Add New Membership Card</h4>
\t<h5 class=\"no-margin-top\">Membership Card</h5>
\t<table width=\"100%\">
\t\t<tr>
\t\t\t<td width=\"25%\" class=\"label\"><label for=\"membership-card-membership-number\"><span class=\"required\">*</span> Membership Number:</label></td>
\t\t\t<td width=\"75%\" class=\"no-padding\">
\t\t\t\t<input type=\"text\" id=\"membership-card-membership-number\" data-message=\"Please enter a membership number.\" required=\"required\" class=\"no-margin integer full\" value=\"\" />
\t\t\t</td>
\t\t</tr>
\t</table>
\t<h5>Availability</h5>
\t<table width=\"100%\">
\t\t<tr>
\t\t\t<td width=\"25%\" class=\"label\"><label for=\"membership-card-valid-from-date\"><span class=\"required\">*</span> Valid From Date:</label></td>
\t\t\t<td width=\"25%\" class=\"no-padding\">
\t\t\t\t<input type=\"text\" id=\"membership-card-valid-from-date\" data-message=\"Please enter the date you want the membership card to be available from.\" required=\"required\" class=\"no-margin full\" value=\"";
        // line 17
        ...
        echo "\" />
\t\t\t\t<input type=\"hidden\" id=\"membership-card-valid-from-date-formatted\" value=\"";
        // line 18
        ...
        echo "\" />
\t\t\t</td>
\t\t\t<td width=\"25%\" class=\"label\"><label for=\"membership-card-expiry-date\"><span class=\"required\">*</span> Expiry Date:</label></td>
\t\t\t<td width=\"25%\" class=\"no-padding\">
\t\t\t\t<input type=\"text\" id=\"membership-card-expiry-date\" data-message=\"Please enter the date you want the membership card to expire.\" required=\"required\" class=\"no-margin full\" value=\"";
        // line 22
        ...
        echo "\" />
\t\t\t\t<input type=\"hidden\" id=\"membership-card-expiry-date-formatted\" value=\"";
        // line 23
...
\t</table>
\t<div class=\"ac\">
\t\t<button class=\"button bottom-button ui-button-green action-add-membership-card\" data-icon-primary=\"ui-icon-tag\">Add New Membership Card</button>
\t\t<button class=\"button bottom-button ui-button-blue action-cancel-add-membership-card\">Cancel</button>
\t</div>
</div>";
    }
    ...
    {
        return "WebIlluminationAdminBundle:MembershipCards:listingAddMembershipCard.html.twig";
    }
