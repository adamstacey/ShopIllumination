...
class __TwigTemplate_25280150c2d95f2821b1163bba54b5fa extends Twig_Template
{
    ...
    {
        // line 1
        echo "<section id=\"statistics-referrers\">
\t<div id=\"ajax-statistics-referrers\">
\t\t<div class=\"ac\">
\t\t\t<p>Loading data, please wait&hellip;</p>
\t\t\t<p><img alt=\"Loading\" src=\"/bundles/webilluminationadmin/images/loaders/ajax-loader-eeeeee.gif\" /></p>
\t\t</div>
\t</div>
...
\t\t\t";
   ...
   \t\t\t\turl: \"";
        // line 13
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("admin_products_ajax_statistics_referrers"), "html", null, true);
        echo "/";
        echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "product"), "id"), "html", null, true);
        echo "\",
   \t\t\t\tsuccess: function(data) {
   \t\t\t\t\t\$(\"#ajax-statistics-referrers\").html(data);
   \t\t\t\t}
 \t\t\t});
\t\t});
\t</script>
    ...
    {
        return "WebIlluminationAdminBundle:Products:updateStatisticsReferrers.html.twig";
    }
